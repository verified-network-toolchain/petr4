...
do 
  ...
  test -f "ci-test/type-checking/expectation/typechecked/${file1}" && cp "$file" ci-test/type-checking/expectation/typechecked
  test -f "ci-test/type-checking/expectation/p4cTypeChecked/${file1}" && cp "$file" ci-test/type-checking/expectation/p4cTypeChecked
  test -f "ci-test/type-checking/expectation/petr4TypeChecked/${file1}" && cp "$file" ci-test/type-checking/expectation/petr4TypeChecked
done

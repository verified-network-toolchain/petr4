...
@my_anno_2 @name("outer_parser") @my_anno_1 parser MyParser(packet_in buffer, out headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name("inner") InnerParser() inner_0;
    state start {
        hdr.hdr.setInvalid();
...
@my_anno_3 @name("inner_ctrl") control MyIngressInner(inout headers hdr) {
    @name("set_hdr") action set_hdr_0(@name("val") bit<16> val_0) {
        hdr.hdr.field = val_0;
    }
    @my_anno_4 @name("inner_table") table table1_0 {
        actions = {
            set_hdr_0();
            NoAction();
        }
...
@my_anno_5 @my_anno_3 control MyIngress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name("inner") MyIngressInner() inner_1;
    @name("inner.set_hdr") action inner_set_hdr(@name("val") bit<16> val_0) {
        hdr.hdr.field = val_0;
    }
    @my_anno_4 @name("inner.inner_table") table inner_inner_table {
        actions = {
            inner_set_hdr();
            NoAction();
        }

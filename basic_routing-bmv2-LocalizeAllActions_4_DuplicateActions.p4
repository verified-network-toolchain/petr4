...
control egress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name("rewrite_src_dst_mac") action rewrite_src_dst_mac_0(@name("smac") bit<48> smac_0, @name("dmac") bit<48> dmac_0) {
        hdr.ethernet.srcAddr = smac_0;
        hdr.ethernet.dstAddr = dmac_0;
    }
    @name("rewrite_src_dst_mac") action rewrite_src_dst_mac(@name("smac") bit<48> smac_0, @name("dmac") bit<48> dmac_0) {
        hdr.ethernet.srcAddr = smac_0;
        hdr.ethernet.dstAddr = dmac_0;
    }
...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name("set_vrf") action set_vrf_0(@name("vrf") bit<12> vrf_0) {
        meta.ingress_metadata.vrf = vrf_0;
    }
    @name("set_vrf") action set_vrf(@name("vrf") bit<12> vrf_0) {
        meta.ingress_metadata.vrf = vrf_0;
    }
    ...
    @name("fib_hit_nexthop") action fib_hit_nexthop_0(@name("nexthop_index") bit<16> nexthop_index_0) {
        meta.ingress_metadata.nexthop_index = nexthop_index_0;
        hdr.ipv4.ttl = hdr.ipv4.ttl + 8w255;
    }
    @name("fib_hit_nexthop") action fib_hit_nexthop(@name("nexthop_index") bit<16> nexthop_index_0) {
        meta.ingress_metadata.nexthop_index = nexthop_index_0;
        hdr.ipv4.ttl = hdr.ipv4.ttl + 8w255;
    }
    @name("fib_hit_nexthop") action fib_hit_nexthop_1(@name("nexthop_index") bit<16> nexthop_index_0) {
        meta.ingress_metadata.nexthop_index = nexthop_index_0;
        hdr.ipv4.ttl = hdr.ipv4.ttl + 8w255;
    }
    @name("set_egress_details") action set_egress_details_0(@name("egress_spec") bit<9> egress_spec_0) {
        standard_metadata.egress_spec = egress_spec_0;
    }
    @name("set_egress_details") action set_egress_details(@name("egress_spec") bit<9> egress_spec_0) {
        standard_metadata.egress_spec = egress_spec_0;
    }
    @name("set_bd") action set_bd_0(@name("bd") bit<16> bd_1) {
        meta.ingress_metadata.bd = bd_1;
    }
    @name("set_bd") action set_bd(@name("bd") bit<16> bd_1) {
        meta.ingress_metadata.bd = bd_1;
    }
    @name("bd") table bd_0 {
        actions = {

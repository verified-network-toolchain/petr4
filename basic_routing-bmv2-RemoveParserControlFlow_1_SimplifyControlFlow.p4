...
control egress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name("rewrite_src_dst_mac") action rewrite_src_dst_mac_0(@name("smac") bit<48> smac, @name("dmac") bit<48> dmac) {
...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name("set_vrf") action set_vrf_0(@name("vrf") bit<12> vrf_1) {
    ...
    @name("fib_hit_nexthop") action fib_hit_nexthop_0(@name("nexthop_index") bit<16> nexthop_index_1) {
    ...
    @name("set_egress_details") action set_egress_details_0(@name("egress_spec") bit<9> egress_spec_1) {
        standard_metadata.egress_spec = egress_spec_1;
    }
    @name("set_bd") action set_bd_0(@name("bd") bit<16> bd_0) {

...
let check_command =
  ...
  Command.basic_spec
    ...
    (empty
     ...
     +> anon ("p4file" %: string))
    (fun verbose include_dir json pretty exportp4 export_file typed_json p4file () ->
       ignore (check_file include_dir p4file json pretty exportp4 export_file typed_json verbose))

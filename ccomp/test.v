...
Definition v___stringlit_1 := {|
  ...
  gvar_init := (Init_int8 (Int.repr 45) :: Init_int8 (Int.repr 48) ::
                ...
                Init_int8 (Int.repr 51) :: Init_int8 (Int.repr 52) ::
                Init_int8 (Int.repr 53) :: Init_int8 (Int.repr 54) ::
                Init_int8 (Int.repr 55) :: Init_int8 (Int.repr 56) ::
                Init_int8 (Int.repr 57) :: Init_int8 (Int.repr 0) :: nil);
  gvar_readonly := true;
  gvar_volatile := false
|}.
...
(Ssequence
  (Ssequence
    (Scall None
      ...
      ((Evar ___stringlit_1 (tarray tschar 12)) :: nil))

...
parser parserI(packet_in pkt, out headers hdr, inout metadata meta, inout standard_metadata_t stdmeta) {
    ...
    @name("tmp_4") tcp_upto_data_offset_only_h tmp_4;
    @name("tmp_5") bit<9> tmp_5;
    @name("tmp_6") bit<9> tmp_6;
    @name("tmp_7") bit<9> tmp_7;
    @name("tmp_8") bit<32> tmp_8;
    state start {

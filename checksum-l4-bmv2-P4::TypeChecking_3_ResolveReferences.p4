...
parser parserI(packet_in pkt, out headers hdr, inout metadata meta, inout standard_metadata_t stdmeta) {
    ...
    state parse_ipv4 {
        ...
        meta.l4Len = hdr.ipv4.totalLen - (bit<16>)hdr.ipv4.ihl * 16w4;
    ...
    state parse_tcp {
        pkt.extract<tcp_t>(hdr.tcp, (bit<32>)(9w8 * (9w4 * (bit<9>)(pkt.lookahead<tcp_upto_data_offset_only_h>()).dataOffset - 9w20)));

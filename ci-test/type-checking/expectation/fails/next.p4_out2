/petr4/ci-test/type-checking/testdata/p4_16_samples/fabric_20190420/include/control/next.p4
\n
/*
...
Uncaught exception:
  ...
  Petr4.Prog.Env.UnboundName("NEXT_VLAN_TABLE_SIZE")
...
Called from Petr4__Checker.type_table' in file "lib/checker.ml", line 3600, characters 23-57
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/fabric_20190420/include/control/next.p4(84): [--Werror=not-found] error: NEXT_VLAN_TABLE_SIZE: declaration not found
        size = NEXT_VLAN_TABLE_SIZE;
               ^^^^^^^^^^^^^^^^^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/fabric_20190420/include/control/next.p4(116): [--Werror=not-found] error: XCONNECT_NEXT_TABLE_SIZE: declaration not found
        size = XCONNECT_NEXT_TABLE_SIZE;
               ^^^^^^^^^^^^^^^^^^^^^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/fabric_20190420/include/control/next.p4(165): [--Werror=not-found] error: HASHED_ACT_PROFILE_SIZE: declaration not found
    action_selector(HashAlgorithm.crc16, HASHED_ACT_PROFILE_SIZE, 32w16) hashed_selector;
                                         ^^^^^^^^^^^^^^^^^^^^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/fabric_20190420/include/control/next.p4(202): [--Werror=not-found] error: HASHED_NEXT_TABLE_SIZE: declaration not found
        size = HASHED_NEXT_TABLE_SIZE;
               ^^^^^^^^^^^^^^^^^^^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/fabric_20190420/include/control/next.p4(228): [--Werror=not-found] error: MULTICAST_NEXT_TABLE_SIZE: declaration not found
        size = MULTICAST_NEXT_TABLE_SIZE;
               ^^^^^^^^^^^^^^^^^^^^^^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/fabric_20190420/include/control/next.p4(302): [--Werror=not-found] error: EGRESS_VLAN_TABLE_SIZE: declaration not found
        size = EGRESS_VLAN_TABLE_SIZE;
               ^^^^^^^^^^^^^^^^^^^^^^

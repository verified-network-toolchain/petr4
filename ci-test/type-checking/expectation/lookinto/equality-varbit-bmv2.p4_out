/petr4/ci-test/type-checking/testdata/p4_16_samples/equality-varbit-bmv2.p4
\n
#include <core.p4>
#include <v1model.p4>
...
parser p(packet_in b, out headers hdr, inout metadata meta,
         inout standard_metadata_t stdmeta) {
  state start {
    b.extract(hdr.h, 32);
    transition accept;
...
V1Switch<headers, metadata>(p(), vc(), ingress(), egress(), uc(), deparser())
  main;

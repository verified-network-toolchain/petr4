/petr4/ci-test/type-checking/testdata/p4_16_samples/fabric_20190420/include/control/filtering.p4
\n
/*
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/fabric_20190420/include/control/filtering.p4(64): [--Werror=not-found] error: PORT_VLAN_TABLE_SIZE: declaration not found
        size = PORT_VLAN_TABLE_SIZE;
               ^^^^^^^^^^^^^^^^^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/fabric_20190420/include/control/filtering.p4(98): [--Werror=not-found] error: FWD_CLASSIFIER_TABLE_SIZE: declaration not found
        size = FWD_CLASSIFIER_TABLE_SIZE;
               ^^^^^^^^^^^^^^^^^^^^^^^^^

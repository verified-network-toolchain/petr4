/petr4/ci-test/type-checking/testdata/p4_16_samples/flag_lost-bmv2.p4
\n
/* -*- P4_16 -*- */
#include <core.p4>
#include <v1model.p4>
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/flag_lost-bmv2.p4(69): [--Wwarn=unused] warning: 'dstAddr' is unused
    action ipv4_forward(macAddr_t dstAddr, egressSpec_t port) {
                                  ^^^^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/flag_lost-bmv2.p4(69): [--Wwarn=unused] warning: 'port' is unused
    action ipv4_forward(macAddr_t dstAddr, egressSpec_t port) {
                                                        ^^^^

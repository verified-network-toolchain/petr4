/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_exit_combination_4-bmv2.p4
\n
#include <core.p4>
#include <v1model.p4>
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_exit_combination_4-bmv2.p4(33): [--Wwarn=ignore-prop] warning: KeyElement: constant key element
            48w100: exact @name("key") ;
            ^^^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_exit_combination_4-bmv2.p4(33): [--Wwarn=mismatch] warning: 48w100: Constant key field
            48w100: exact @name("key") ;
            ^^^^^^

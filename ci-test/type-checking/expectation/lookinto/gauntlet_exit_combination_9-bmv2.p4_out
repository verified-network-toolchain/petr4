/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_exit_combination_9-bmv2.p4
\n
#include <core.p4>
#include <v1model.p4>
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_exit_combination_9-bmv2.p4(35): [--Wwarn=ignore-prop] warning: KeyElement: constant key element
            48w1: exact @name("Vmhbwk") ;
            ^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_exit_combination_9-bmv2.p4(35): [--Wwarn=mismatch] warning: 48w1: Constant key field
            48w1: exact @name("Vmhbwk") ;
            ^^^^

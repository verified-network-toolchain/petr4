/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_function_return-bmv2.p4
\n
#include <core.p4>
#include <v1model.p4>
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_function_return-bmv2.p4(15): [--Wwarn=uninitialized_out_param] warning: out parameter 'd' may be uninitialized when 'do_thing' terminates
bit<8> do_thing(out bit<32> d) {
                            ^
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_function_return-bmv2.p4(15)
bit<8> do_thing(out bit<32> d) {
       ^^^^^^^^

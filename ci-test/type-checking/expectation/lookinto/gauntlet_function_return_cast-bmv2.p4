/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_function_return_cast-bmv2.p4
\n
#include <core.p4>
#include <v1model.p4>
...
control ingress(inout Headers h, inout Meta m, inout standard_metadata_t sm) {
    ...
    apply {
        h.eth_hdr.eth_type = (bit<16>)do_function();
    }
}
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_function_return_cast-bmv2.p4(18): [--Wwarn=mismatch] warning: -8w1: negative value with unsigned type
    return -1;
            ^

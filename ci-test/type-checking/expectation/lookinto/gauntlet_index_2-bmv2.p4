/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_index_2-bmv2.p4
\n
#include <core.p4>
#include <v1model.p4>
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_index_2-bmv2.p4(40): [--Wwarn=ignore-prop] warning: KeyElement: constant key element
            32w1 : exact @name("IymcAg") ;
            ^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_index_2-bmv2.p4(40): [--Wwarn=mismatch] warning: 32w1: Constant key field
            32w1 : exact @name("IymcAg") ;
            ^^^^

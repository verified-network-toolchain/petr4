/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_index_6-bmv2.p4
\n
#include <core.p4>
#include <v1model.p4>
header ethernet_t {
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_index_6-bmv2.p4(34): [--Wwarn=unused] warning: 'val' is unused
    action simple_action(inout bit<8> val) { }
                                      ^^^

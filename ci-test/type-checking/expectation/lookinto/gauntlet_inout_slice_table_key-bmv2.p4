/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_inout_slice_table_key-bmv2.p4
\n
#include <core.p4>
#include <v1model.p4>
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_inout_slice_table_key-bmv2.p4(28): [--Wwarn=unused] warning: 'dummy' is unused
    action simple_action(inout bit<4> dummy) {
                                      ^^^^^

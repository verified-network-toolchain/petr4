/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_mux_hdr-bmv2.p4
\n
#include <core.p4>
#include <v1model.p4>
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_mux_hdr-bmv2.p4(26): [--Wwarn=invalid_header] warning: accessing a field of an invalid header tmp2[0]
    if (tmp2[0].a <= 3) {
        ^^^^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_mux_hdr-bmv2.p4(26): [--Wwarn=uninitialized_use] warning: tmp2[0].a may be uninitialized
    if (tmp2[0].a <= 3) {
        ^^^^^^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_mux_hdr-bmv2.p4(27): [--Wwarn=uninitialized_use] warning: tmp2[1] may not be completely initialized
        tmp1[0] = tmp2[1];
                  ^^^^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_mux_hdr-bmv2.p4(28): [--Wwarn=uninitialized_use] warning: tmp1[1] may not be completely initialized
        tmp2[1] = tmp1[1];
                  ^^^^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_mux_hdr-bmv2.p4(30): [--Wwarn=invalid_header] warning: accessing a field of an invalid header tmp1[0]
    return tmp1[0].a;
           ^^^^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_mux_hdr-bmv2.p4(30): [--Wwarn=uninitialized_use] warning: tmp1[0].a may be uninitialized
    return tmp1[0].a;
           ^^^^^^^^^

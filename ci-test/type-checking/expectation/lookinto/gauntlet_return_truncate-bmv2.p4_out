/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_return_truncate-bmv2.p4
\n
#include <core.p4>
#include <v1model.p4>
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_return_truncate-bmv2.p4(31): [--Wwarn=unused] warning: 'hyhe' is unused
    action iuJze(in bit<8> hyhe) {
                           ^^^^

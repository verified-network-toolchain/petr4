/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_short_circuit-bmv2.p4
\n
#include <core.p4>
#include <v1model.p4>
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_short_circuit-bmv2.p4(23): [--Wwarn=uninitialized_use] warning: val may be uninitialized
    return val;
           ^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_short_circuit-bmv2.p4(22): [--Wwarn=uninitialized_out_param] warning: out parameter 'val' may be uninitialized when 'do_function' terminates
bit<8> do_function(out bit<8> val) {
                              ^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_short_circuit-bmv2.p4(22)
bit<8> do_function(out bit<8> val) {
       ^^^^^^^^^^^

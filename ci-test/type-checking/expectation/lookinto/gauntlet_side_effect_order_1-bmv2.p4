/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_side_effect_order_1-bmv2.p4
\n
#include <core.p4>
#include <v1model.p4>
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_side_effect_order_1-bmv2.p4(37): [--Wwarn=ordering] warning: val: 'out' argument has fields in common with val
        do_action_1(val, val);
                    ^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_side_effect_order_1-bmv2.p4(37)
        do_action_1(val, val);
                         ^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_side_effect_order_1-bmv2.p4(37): [--Wwarn=ordering] warning: val: 'out' argument has fields in common with val
        do_action_1(val, val);
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_side_effect_order_1-bmv2.p4(37)
        do_action_1(val, val);
                    ^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_side_effect_order_1-bmv2.p4(34): [--Wwarn=uninitialized_use] warning: val_2 may be uninitialized
        val_1 = val_2;
                ^^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_side_effect_order_1-bmv2.p4(33): [--Wwarn=uninitialized_out_param] warning: out parameter 'val_2' may be uninitialized when 'do_action_1' terminates
    action do_action_1(out bit<16> val_1, out bit<16> val_2) {
                                                      ^^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_side_effect_order_1-bmv2.p4(33)
    action do_action_1(out bit<16> val_1, out bit<16> val_2) {
           ^^^^^^^^^^^

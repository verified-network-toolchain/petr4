...
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_side_effect_order_3-bmv2.p4(25): [--Wwarn=uninitialized_out_param] warning: out parameter 'val' may be uninitialized when 'do_thing' terminates
bit<8> do_thing(out bit<8> val) {
                           ^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_side_effect_order_3-bmv2.p4(25)
bit<8> do_thing(out bit<8> val) {
       ^^^^^^^^

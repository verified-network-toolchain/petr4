/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_switch_nested_table_apply-bmv2.p4
\n
#include <core.p4>
#include <v1model.p4>
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_switch_nested_table_apply-bmv2.p4(34): [--Wwarn=ignore-prop] warning: KeyElement: constant key element
            128w1 : exact @name("JGOUaj") ;
            ^^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_switch_nested_table_apply-bmv2.p4(42): [--Wwarn=ignore-prop] warning: KeyElement: constant key element
            48w1: exact @name("qkgOtm") ;
            ^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_switch_nested_table_apply-bmv2.p4(34): [--Wwarn=mismatch] warning: 128w1: Constant key field
            128w1 : exact @name("JGOUaj") ;
            ^^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_switch_nested_table_apply-bmv2.p4(42): [--Wwarn=mismatch] warning: 48w1: Constant key field
            48w1: exact @name("qkgOtm") ;
            ^^^^

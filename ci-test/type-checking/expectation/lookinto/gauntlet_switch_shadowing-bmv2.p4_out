/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_switch_shadowing-bmv2.p4
\n
#include <core.p4>
#include <v1model.p4>
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_switch_shadowing-bmv2.p4(16): [--Wwarn=uninitialized_out_param] warning: out parameter 'val' may be uninitialized when 'set_undefined' terminates
bit<2> set_undefined(out bit<32> val) {
                                 ^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_switch_shadowing-bmv2.p4(16)
bit<2> set_undefined(out bit<32> val) {
       ^^^^^^^^^^^^^

/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_table_call_in_expression-bmv2.p4
\n
#include <core.p4>
#include <v1model.p4>
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_table_call_in_expression-bmv2.p4(32): [--Wwarn=shadow] warning: 'simple_action' shadows 'simple_action'
    action simple_action() {
           ^^^^^^^^^^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_table_call_in_expression-bmv2.p4(14)
bit<16> simple_action() {
        ^^^^^^^^^^^^^

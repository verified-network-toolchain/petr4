/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_uninitialized_bool_struct-bmv2.p4
\n
#include <core.p4>
#include <v1model.p4>
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_uninitialized_bool_struct-bmv2.p4(33): [--Wwarn=unused] warning: 'dummy_bit' is unused
    action dummy_action(out bit<16> dummy_bit, out bool_struct dummy_struct) {
                                    ^^^^^^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_uninitialized_bool_struct-bmv2.p4(33): [--Wwarn=unused] warning: 'dummy_struct' is unused
    action dummy_action(out bit<16> dummy_bit, out bool_struct dummy_struct) {
                                                               ^^^^^^^^^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_uninitialized_bool_struct-bmv2.p4(33): [--Wwarn=uninitialized_out_param] warning: out parameter 'dummy_bit' may be uninitialized when 'dummy_action' terminates
    action dummy_action(out bit<16> dummy_bit, out bool_struct dummy_struct) {
                                    ^^^^^^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_uninitialized_bool_struct-bmv2.p4(33)
    action dummy_action(out bit<16> dummy_bit, out bool_struct dummy_struct) {
           ^^^^^^^^^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_uninitialized_bool_struct-bmv2.p4(33): [--Wwarn=uninitialized_out_param] warning: out parameter 'dummy_struct' may be uninitialized when 'dummy_action' terminates
    action dummy_action(out bit<16> dummy_bit, out bool_struct dummy_struct) {
                                                               ^^^^^^^^^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_uninitialized_bool_struct-bmv2.p4(33)
    action dummy_action(out bit<16> dummy_bit, out bool_struct dummy_struct) {

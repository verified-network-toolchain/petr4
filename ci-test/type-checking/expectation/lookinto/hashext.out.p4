/petr4/ci-test/type-checking/testdata/p4_16_samples/hashext.p4
\n
/*
...
extern hash_function<O0, T1> crc_poly<O0, T1>(O0 poly);
header h1_t {
  bit<32> f1;
  bit<32> f2;
  bit<32> f3;
...
control test(inout hdrs hdr) {
  apply {
    hdr.crc = crc_poly<bit<16>, h1_t>(16w32794).hash(hdr.h1);
  }
}

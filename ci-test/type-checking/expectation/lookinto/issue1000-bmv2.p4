/petr4/ci-test/type-checking/testdata/p4_16_samples/issue1000-bmv2.p4
\n
/*
...
parser ParserImpl(packet_in packet, out headers hdr, inout metadata meta,
  ...
  state parse_ethernet
    ...
    packet.extract(hdr.ethernet);
    transition select(hdr.ethernet.dstAddr[47:40],
      hdr.ethernet.dstAddr[39:32], hdr.ethernet.dstAddr[31:24])
      {
      (202, 254, 173): a7;
      (202, 254, _): a6;
      (202, _, 173): a5;
  ...
  state a0 {
    meta.transition_taken = 160;
    transition accept;
  }
  state a1 {
    meta.transition_taken = 161;
    transition accept;
  }
  state a2 {
    meta.transition_taken = 162;
    transition accept;
  }
  state a3 {
    meta.transition_taken = 163;
    transition accept;
  }
  state a4 {
    meta.transition_taken = 164;
    transition accept;
  }
  state a5 {
    meta.transition_taken = 165;
    transition accept;
  }
  state a6 {
    meta.transition_taken = 166;
    transition accept;
  }
  state a7 {
    meta.transition_taken = 167;
    transition accept;
  }
}

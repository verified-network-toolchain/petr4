/petr4/ci-test/type-checking/testdata/p4_16_samples/issue1210.p4
\n
/*
...
parser ParserImpl(packet_in packet, out parsed_headers_t hdr,
                  inout metadata_t meta,
                  inout standard_metadata_t standard_metadata) {
  state start {
    transition accept;
...
control IngressImpl(inout parsed_headers_t hdr, inout metadata_t meta,
                    inout standard_metadata_t standard_metadata) {
  apply
    {
    if (meta.foo==meta.bar) {
...
control EgressImpl(inout parsed_headers_t hdr, inout metadata_t meta,
                   inout standard_metadata_t standard_metadata) {
  apply { 
  }
}

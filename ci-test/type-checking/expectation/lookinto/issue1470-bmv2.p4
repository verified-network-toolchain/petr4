/petr4/ci-test/type-checking/testdata/p4_16_samples/issue1470-bmv2.p4
\n
#include "v1model.p4"
...
parser OuterParser(packet_in pkt, out headers_t hdr, inout meta_t m,
...
control NoIngress(inout headers_t hdr, inout meta_t m,
                  inout standard_metadata_t meta) {
  apply { 
  }
}
control NoEgress(inout headers_t hdr, inout meta_t m,
                 inout standard_metadata_t meta) {
  apply { 
  }
}
...
V1Switch(OuterParser(), NoVerify(), NoIngress(), NoEgress(), NoCheck(),
           SimpleDeparser())
  main;

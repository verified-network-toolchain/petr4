/petr4/ci-test/type-checking/testdata/p4_16_samples/issue1541.p4
\n
#include <core.p4>
#include <v1model.p4>
struct metadata {
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/issue1541.p4(25): [--Wwarn=shadow] warning: 'hash' shadows 'hash'
    action hash() {
           ^^^^
/petr4/ci-test/type-checking/p4include/v1model.p4(444)

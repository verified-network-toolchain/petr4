/petr4/ci-test/type-checking/testdata/p4_16_samples/issue1653-complex-bmv2.p4
\n
/*
...
V1Switch(parse(), verifyChecksum(), ingress(), egress(), compute_checksum(),
           deparser())
  main;

************************\n******** p4c type checking result: ********\n************************\n
/petr4/ci-test/type-checking/testdata/p4_16_samples/issue1653-complex-bmv2.p4(94): [--Wwarn=invalid_header] warning: accessing a field of an invalid header bh
        bh.row.alt0.useHash = h.bvh0.row.alt0.useHash;
        ^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/issue1653-complex-bmv2.p4(95): [--Wwarn=invalid_header] warning: accessing a field of an invalid header bh
        bh.row.alt1.type = EthTypes.IPv4;
        ^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/issue1653-complex-bmv2.p4(96): [--Wwarn=invalid_header] warning: accessing a field of an invalid header bh
        h.bvh0.row.alt1.type = bh.row.alt1.type;
                               ^^

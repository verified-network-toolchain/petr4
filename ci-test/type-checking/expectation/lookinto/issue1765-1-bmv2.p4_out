/petr4/ci-test/type-checking/testdata/p4_16_samples/issue1765-1-bmv2.p4
\n
#include <core.p4>
#include <v1model.p4>
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/issue1765-1-bmv2.p4(237): [--Wwarn=unused] warning: Table ndp_answer is not used; removing
    table ndp_answer {
          ^^^^^^^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/issue1765-1-bmv2.p4(250): [--Wwarn=unused] warning: Table port2mcast is not used; removing
    table port2mcast {
          ^^^^^^^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/issue1765-1-bmv2.p4(262): [--Wwarn=unused] warning: Table addr2mcast is not used; removing
    table addr2mcast {
          ^^^^^^^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/issue1765-1-bmv2.p4(274): [--Wwarn=unused] warning: Table ndp is not used; removing
    table ndp {
          ^^^

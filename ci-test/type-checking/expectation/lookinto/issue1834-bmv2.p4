/petr4/ci-test/type-checking/testdata/p4_16_samples/issue1834-bmv2.p4
\n
/* -*- P4_16 -*- */
#include <core.p4>
#include <v1model.p4>
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/issue1834-bmv2.p4(23): [--Wwarn=unused] warning: 'a' is unused
    action act(test_t a) { } // did not work before PR #1792 was merged
                      ^

...
/petr4/ci-test/type-checking/testdata/p4_16_samples/issue2175-3.p4(7): [--Wwarn=unused] warning: c1_x: unused instance
    X() c1_x = {
        ^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/issue2175-3.p4(12): [--Wwarn=unused] warning: c2_x: unused instance
    X() c2_x = {
        ^^^^

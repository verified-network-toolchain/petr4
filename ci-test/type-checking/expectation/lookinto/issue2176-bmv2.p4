/petr4/ci-test/type-checking/testdata/p4_16_samples/issue2176-bmv2.p4
\n
#include <core.p4>
#include <v1model.p4>
...
control ingress(inout Parsed_packet h, inout Metadata m,
                inout standard_metadata_t sm) {
  action
    do_action_2(inout bit<8> val_0, inout bit<8> val_1, inout bit<8> val_2)
    {
    val_1 = 8w2;
    val_2 = 8w0;
  }
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/issue2176-bmv2.p4(38): [--Wwarn=unused] warning: 'val_0' is unused
    action do_action_2(inout bit<8> val_0, inout bit<8> val_1, inout bit<8> val_2) {
                                    ^^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/issue2176-bmv2.p4(43): [--Wwarn=ordering] warning: h.h.b: 'out' argument has fields in common with h.h.b
        do_action_2(h.h.b, h.h.b, h.h.b);
                    ^^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/issue2176-bmv2.p4(43)
        do_action_2(h.h.b, h.h.b, h.h.b);
                           ^^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/issue2176-bmv2.p4(43): [--Wwarn=ordering] warning: h.h.b: 'out' argument has fields in common with h.h.b
        do_action_2(h.h.b, h.h.b, h.h.b);

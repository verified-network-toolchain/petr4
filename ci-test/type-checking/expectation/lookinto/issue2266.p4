/petr4/ci-test/type-checking/testdata/p4_16_samples/issue2266.p4
\n
#include <core.p4>
#include <v1model.p4>
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/issue2266.p4(32): [--Wwarn=unused] warning: 'val' is unused
    action simple_action(in bit<16> val) {
                                    ^^^

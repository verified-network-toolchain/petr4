/petr4/ci-test/type-checking/testdata/p4_16_samples/issue2287-bmv2.p4
\n
#include <core.p4>
#include <v1model.p4>
...
control ingress(inout Headers h, inout Meta m, inout standard_metadata_t sm) {
  apply
    ...
    dummy_bool = false && bool_with_side_effect(h.b.b);
    dummy_bool =
    function_with_side_effect(h.b.c)!=function_with_side_effect(h.b.c);
    dummy_bool =
    function_with_side_effect(h.b.d)==function_with_side_effect(h.b.d);
  }
}

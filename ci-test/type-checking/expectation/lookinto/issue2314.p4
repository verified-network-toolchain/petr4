/petr4/ci-test/type-checking/testdata/p4_16_samples/issue2314.p4
\n
/*
...
parser MyParser(packet_in b, out h hdr, inout m meta,
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/issue2314.p4(71): [--Wwarn=uninitialized_use] warning: hdr may not be completely initialized
    l3.apply(b, hdr);
                ^^^

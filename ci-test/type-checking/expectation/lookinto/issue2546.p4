/petr4/ci-test/type-checking/testdata/p4_16_samples/issue2546.p4
\n
#include <core.p4>
header ethernet_t {
    bit<48> dst_addr;
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/issue2546.p4(26): [--Wwarn=ignore-prop] warning: KeyElement: constant key element
            48w1: exact @name("KOXpQP") ;
            ^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/issue2546.p4(26): [--Wwarn=mismatch] warning: 48w1: Constant key field
            48w1: exact @name("KOXpQP") ;
            ^^^^

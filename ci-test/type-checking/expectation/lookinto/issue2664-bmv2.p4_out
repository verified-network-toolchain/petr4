/petr4/ci-test/type-checking/testdata/p4_16_samples/issue2664-bmv2.p4
\n
#include <core.p4>
#include <v1model.p4>
...
extern Checksum {
  Checksum();
  void add<T35>(in T35 data);
  void subtract<T36>(in T36 data);
  bool verify();
  bit<16> get();
  bit<16> update<T37>(in T37 data, @optional

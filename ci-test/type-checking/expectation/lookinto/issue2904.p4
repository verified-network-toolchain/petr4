/petr4/ci-test/type-checking/testdata/p4_16_samples/issue2904.p4
\n
#include "core.p4"
#include "v1model.p4"
...
control ingress(inout headers_t headers,
  ...
  table X
    ...
    const entries =
      {
      0: A(TableType.TT_ACL);
      1: A(TableType.TT_FWD);
      _: A(TableType.TT_FWD);
    }
  }
  apply {
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/issue2904.p4(34): [--Wwarn=uninitialized_use] warning: y may be uninitialized
    key = { y : ternary;
            ^

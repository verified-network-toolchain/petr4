/petr4/ci-test/type-checking/testdata/p4_16_samples/issue407-2.p4
\n
/*
...
typedef tuple<bit<8>, bit<16>> myTuple0;
typedef
  tuple<bit<7>, int<33>, EthernetAddress, MySignedInt, varbit <56>,
    varbit <104>, error, bool, myenum1, Ethernet_h, Ethernet_h[4], mystruct1,
    mystruct2, myTuple0>
  myTuple1;
header MyHeader1 {
  bit<8> x1;

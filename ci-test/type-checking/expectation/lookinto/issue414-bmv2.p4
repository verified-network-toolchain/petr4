/petr4/ci-test/type-checking/testdata/p4_16_samples/issue414-bmv2.p4
\n
/*
...
parser parserI(packet_in pkt, out Parsed_packet hdr, inout mystruct1 meta,
               inout standard_metadata_t stdmeta) {
  const bit<32> c1d = 32w3405691582;
  bit<8> b1a;
  state start {
    pkt.extract(hdr.ethernet);
    transition accept;
...
control cIngress(inout Parsed_packet hdr, inout mystruct1 meta,
                 inout standard_metadata_t stdmeta) {
  cBar() cbar_inst2;
  action foo() {
    meta.b = meta.b+5;
...
control cEgress(inout Parsed_packet hdr, inout mystruct1 meta,
                inout standard_metadata_t stdmeta) {
  apply { 
  }
}
...
V1Switch<Parsed_packet, mystruct1>(parserI(), vc(), cIngress(), cEgress(),
                                     uc(), DeparserI())
  main;

************************\n******** p4c type checking result: ********\n************************\n
/petr4/ci-test/type-checking/testdata/p4_16_samples/issue414-bmv2.p4(64): [--Wwarn=unused] warning: cbar_inst2: unused instance
    cBar() cbar_inst2;
           ^^^^^^^^^^

/petr4/ci-test/type-checking/testdata/p4_16_samples/issue496.p4
\n
#include <v1model.p4>
...
@pure
extern void hash<O, T8, D9, M>(out O result, in HashAlgorithm algo,
                               in T8 base, in D9 data, in M max);
...
control MyIngress(inout my_packet p, inout my_metadata m,
                  inout standard_metadata_t s) {
  D() d;
  C(d) c;
  apply {

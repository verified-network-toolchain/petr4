/petr4/ci-test/type-checking/testdata/p4_16_samples/nested_if_else.p4
\n
#include <core.p4>
#include <v1model.p4>
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/nested_if_else.p4(75): [--Wwarn=unused] warning: 'offset' is unused
    action if_testing(out bit<16> value, in bit<8> offset) {
                                                   ^^^^^^

/petr4/ci-test/type-checking/testdata/p4_16_samples/noMatch.p4
\n
/*
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/noMatch.p4(20): [--Wwarn=parser-transition] warning: accept state in parser p is unreachable
parser p() {
       ^
/petr4/ci-test/type-checking/testdata/p4_16_samples/noMatch.p4(23): [--Wwarn=uninitialized_use] warning: x may be uninitialized
        transition select(x) {
                          ^
/petr4/ci-test/type-checking/testdata/p4_16_samples/noMatch.p4(20): [--Wwarn=parser-transition] warning: accept state in parser p is unreachable
parser p() {

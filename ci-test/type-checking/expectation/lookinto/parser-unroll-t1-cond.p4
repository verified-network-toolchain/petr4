/petr4/ci-test/type-checking/testdata/p4_16_samples/parser-unroll-t1-cond.p4
\n
...
V1Switch(MyParser(false), MyVerifyChecksum(), MyIngress(), MyEgress(),
           MyComputeChecksum(), MyDeparser())
  main;

************************\n******** p4c type checking result: ********\n************************\n
/petr4/ci-test/type-checking/testdata/p4_16_samples/parser-unroll-t1-cond.p4(107): [--Wwarn=parser-transition] warning: SelectCase: unreachable case
     true : parse_udp;
     ^^^^^^^^^^^^^^^^

/petr4/ci-test/type-checking/testdata/p4_16_samples/pna-example-SelectByDirection.p4
\n
/*
    ...
    inout pna_main_output_metadata_t ostd)
{
    ...
    table ipv4_da_lpm {
        key = {
            SelectByDirection(istd.direction, hdr.ipv4.srcAddr, hdr.ipv4.dstAddr): lpm @name ("ipv4_addr");
        }
        actions = {
            next_hop;
            default_route_drop;

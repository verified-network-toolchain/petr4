...
/petr4/ci-test/type-checking/testdata/p4_16_samples/pr1363.p4(12): [--Wwarn=shadow] warning: 'implementation' shadows 'implementation'
    implementation = ActionProfile(32);
    ^^^^^^^^^^^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/pr1363.p4(3)
typedef bit implementation;
            ^^^^^^^^^^^^^^

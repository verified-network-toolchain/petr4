/petr4/ci-test/type-checking/testdata/p4_16_samples/pred2.p4
\n
/*
...
control Ing() {
  ...
  action cond_0()
    ...
    tmp_2 = (!true && !!true ? a==32w5 : tmp_2);
    tmp_1 =
    (!true && !!true ? (!true && !!true ? a==32w5 : tmp_2) :
      (!true && !true ? false : tmp_1));
  }
  table tbl_cond {
    actions = {
      cond_0;
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/pred2.p4(29): [--Wwarn=uninitialized_use] warning: tmp_1 may be uninitialized
        tmp_1 = (!true && !true ? false : tmp_1);
                                          ^^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/pred2.p4(30): [--Wwarn=uninitialized_use] warning: tmp_2 may be uninitialized
        tmp_2 = (!true && !!true ? a == 32w5 : tmp_2);
                                               ^^^^^

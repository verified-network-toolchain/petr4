/petr4/ci-test/type-checking/testdata/p4_16_samples/predication_issue_3.p4
\n
#include <core.p4>
#include <v1model.p4>
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/predication_issue_3.p4(21): [--Wwarn=shadow] warning: 'bound' shadows 'bound'
bit<3> bound(in bit<3> val, in bit<3> bound) {
                                      ^^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/predication_issue_3.p4(21)
bit<3> bound(in bit<3> val, in bit<3> bound) {
       ^^^^^

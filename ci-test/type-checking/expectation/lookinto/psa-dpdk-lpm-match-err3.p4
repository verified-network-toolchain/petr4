/petr4/ci-test/type-checking/testdata/p4_16_samples/psa-dpdk-lpm-match-err3.p4
\n
#include <core.p4>
#include <psa.p4>
                ...
                inout psa_ingress_output_metadata_t ostd)
{
    ...
    table tbl {
        key = {
            hdr.ipv4.totalLen : lpm;
            hdr.ipv4.newfield : exact;
        }
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/psa-dpdk-lpm-match-err3.p4:2:10: fatal error: psa.p4: No such file or directory
    2 | #include <psa.p4>
      |          ^~~~~~~~

/petr4/ci-test/type-checking/testdata/p4_16_samples/psa-dpdk-table-key-consolidation-if-1.p4
\n
#include <core.p4>
#include <psa.p4>
...
control MyIC(
    ...
    action a3(bit<48> param) { hdr.ethernet.srcAddr = param; }
    table tbl {
        key = {
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/psa-dpdk-table-key-consolidation-if-1.p4:2:10: fatal error: psa.p4: No such file or directory
    2 | #include <psa.p4>
      |          ^~~~~~~~

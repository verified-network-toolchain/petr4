/petr4/ci-test/type-checking/testdata/p4_16_samples/psa-example-digest-bmv2.p4
\n
/*
...
extern DirectCounter<W> {
                     ^
/petr4/ci-test/type-checking/testdata/p4_16_samples/psa-example-digest-bmv2.p4(183): [--Wwarn=unused] warning: 'serEnumT' is unused
    action do_tst (PortId_t egress_port, EthTypes serEnumT) {
                                                  ^^^^^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/psa-example-digest-bmv2.p4(84): [--Wwarn=uninitialized_out_param] warning: out parameter 'parsed_hdr' may be uninitialized when 'CommonParser' terminates
    out headers parsed_hdr,
                ^^^^^^^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/psa-example-digest-bmv2.p4(82)
parser CommonParser(
       ^^^^^^^^^^^^

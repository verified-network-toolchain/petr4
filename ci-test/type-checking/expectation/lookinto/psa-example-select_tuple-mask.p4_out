/petr4/ci-test/type-checking/testdata/p4_16_samples/psa-example-select_tuple-mask.p4
\n
#include <core.p4>
#include <psa.p4>
                         ...
                         in empty_metadata_t recirculate_meta)
{
    state start {
        ...
        transition select(hdr.ethernet.etherType, hdr.ethernet.srcAddr) {
            (0x0800 &&& 0x0F00, 48w0xF00) : parse_ipv4;
            (16w0x0d00, 48w0x200) : parse_tcp;
            default : parse_ipv4;
        }
    }
    state parse_ipv4 {
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/psa-example-select_tuple-mask.p4:2:10: fatal error: psa.p4: No such file or directory
    2 | #include <psa.p4>
      |          ^~~~~~~~

/petr4/ci-test/type-checking/testdata/p4_16_samples/stack-bmv2.p4
\n
/*
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/stack-bmv2.p4(27): [--Wwarn=invalid_header] warning: accessing a field of an invalid header tmp[0]
        tmp[0].f = h.f + 1;
        ^^^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/stack-bmv2.p4(28): [--Wwarn=invalid_header] warning: accessing a field of an invalid header tmp[0]
        h.f = tmp[0].f;
              ^^^^^^

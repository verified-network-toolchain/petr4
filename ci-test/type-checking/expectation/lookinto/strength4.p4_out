/petr4/ci-test/type-checking/testdata/p4_16_samples/strength4.p4
\n
#include <core.p4>
#include <v1model.p4>
...
parser parser_impl(packet_in packet, out headers_t hdr,
                   inout local_metadata_t local_metadata,
                   inout standard_metadata_t standard_metadata) {
  state start {
    transition accept;
...
V1Switch(parser_impl(), verify_checksum_impl(), ingress_impl(),
           egress_impl(), compute_checksum_impl(), deparser_impl())
  main;

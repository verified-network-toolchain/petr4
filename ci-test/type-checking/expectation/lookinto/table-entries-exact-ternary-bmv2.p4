/petr4/ci-test/type-checking/testdata/p4_16_samples/table-entries-exact-ternary-bmv2.p4
\n
/*
...
control ingress(inout Header_t h, inout Meta_t m,
  ...
  table t_exact_ternary
    ...
    actions = {
      a;a_with_control_params;
    }
    default_action = a;
    const entries =
      {
      (1, 4369 &&& 15): a_with_control_params(1);
      (2, 4481): a_with_control_params(2);
      (3, 4369 &&& 61440): a_with_control_params(3);
      (4, _): a_with_control_params(4);
    }
  }
  apply {
    t_exact_ternary.apply();

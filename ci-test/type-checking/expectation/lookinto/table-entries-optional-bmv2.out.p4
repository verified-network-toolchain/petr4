/petr4/ci-test/type-checking/testdata/p4_16_samples/table-entries-optional-bmv2.p4
\n
/*
...
control ingress(inout Header_t h, inout Meta_t m,
  ...
  table t_optional
    ...
    const entries =
      {
      (170, 4369): a_with_control_params(1);
      (_, 4369): a_with_control_params(2);
      (170, _): a_with_control_params(3);
      (_, _): a_with_control_params(4);
    }
  }
  apply {

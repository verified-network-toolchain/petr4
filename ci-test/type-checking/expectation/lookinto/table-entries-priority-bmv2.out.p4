/petr4/ci-test/type-checking/testdata/p4_16_samples/table-entries-priority-bmv2.p4
\n
/*
...
control ingress(inout Header_t h, inout Meta_t m,
  ...
  table t_ternary
    ...
    const entries =
      {
      4369 &&& 15: a_with_control_params(1)@priority(3)
      ;
      4481: a_with_control_params(2);
      4481 &&& 61455: a_with_control_params(3)@priority(1)
      ;
    }
  }
  apply {

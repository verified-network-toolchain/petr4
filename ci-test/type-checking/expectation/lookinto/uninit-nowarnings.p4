/petr4/ci-test/type-checking/testdata/p4_16_samples/uninit-nowarnings.p4
\n
/*
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/uninit-nowarnings.p4(73): [--Wwarn=uninitialized_out_param] warning: out parameter 'v' may be uninitialized when 'c' terminates
control c(out bit<32> v) { // uninitialized
                      ^
/petr4/ci-test/type-checking/testdata/p4_16_samples/uninit-nowarnings.p4(73)
control c(out bit<32> v) { // uninitialized
        ^

/petr4/ci-test/type-checking/testdata/p4_16_samples/pvs-struct-1-bmv2.p4
\n
#include <v1model.p4>
  ...
  ("cannot cast"
   (expr
    ((I
      (filename
       /petr4/ci-test/type-checking/testdata/p4_16_samples/pvs-struct-1-bmv2.p4)
      (line_start 27) (line_end ()) (col_start 12) (col_end 15))
     ((expr
       (Name
        (BareName
         ((I
        ...
        (TypeName
         (BareName
          ((I
            (filename
             /petr4/ci-test/type-checking/testdata/p4_16_samples/pvs-struct-1-bmv2.p4)
            (line_start 22) (line_end ()) (col_start 14) (col_end 25))
           value_set_t)))))
      (dir Directionless))))
   (typ (Bit ((width 32)))))

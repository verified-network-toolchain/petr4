...
/petr4/ci-test/type-checking/testdata/p4_16_samples/annotation-bug.p4(24): [--Wwarn=uninitialized_use] warning: hdr.ipv4_option_timestamp may not be completely initialized
        get<headers>({ hdr.ipv4_option_timestamp });
                       ^^^^^^^^^^^^^^^^^^^^^^^^^

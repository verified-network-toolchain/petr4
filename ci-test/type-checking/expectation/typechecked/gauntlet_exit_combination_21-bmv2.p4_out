/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_exit_combination_21-bmv2.p4
\n
#include <core.p4>
#include <v1model.p4>
...
control ingress(inout Headers h, inout Meta m, inout standard_metadata_t sm) {
    ...
    apply {
        h.eth_hdr.eth_type = (false ? (tbl.apply().hit ? 16w1 : 16w2) : 16w3);
        exit;
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_exit_combination_21-bmv2.p4(31): [--Wwarn=unused] warning: Table tbl is not used; removing
    table tbl {
          ^^^

/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_index_5-bmv2.p4
\n
#include <core.p4>
#include <v1model.p4>
header ethernet_t {
...
control ingress(inout Headers h, inout Meta m, inout standard_metadata_t sm) {
    action simple_action(inout bit<32> dummy) {}
    apply {
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_index_5-bmv2.p4(33): [--Wwarn=unused] warning: 'dummy' is unused
    action simple_action(inout bit<32> dummy) {}
                                       ^^^^^

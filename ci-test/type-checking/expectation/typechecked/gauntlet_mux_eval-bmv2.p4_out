/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_mux_eval-bmv2.p4
\n
#include <core.p4>
#include <v1model.p4>
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_mux_eval-bmv2.p4(31): [--Wwarn=uninitialized_use] warning: tmp.src_addr may be uninitialized
        h.eth_hdr.src_addr = tmp.src_addr;
                             ^^^^^^^^^^^^

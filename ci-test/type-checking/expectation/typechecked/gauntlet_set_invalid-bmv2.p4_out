/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_set_invalid-bmv2.p4
\n
#include <core.p4>
#include <v1model.p4>
...
parser p(packet_in pkt, out Headers h, inout Meta meta,
...
control ingress(inout Headers h, inout Meta meta,
                inout standard_metadata_t stdmeta) {
  apply {
    h.h.a = 8w1;
    h.h.setInvalid();
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_set_invalid-bmv2.p4(37): [--Wwarn=invalid_header] warning: accessing a field of an invalid header h.h
        h.h.b = 8w1;
        ^^^

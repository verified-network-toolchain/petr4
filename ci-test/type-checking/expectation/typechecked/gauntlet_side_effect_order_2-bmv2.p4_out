/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_side_effect_order_2-bmv2.p4
\n
#include <core.p4>
#include <v1model.p4>
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_side_effect_order_2-bmv2.p4(33): [--Wwarn=unused] warning: 'tmp' is unused
    action do_thing(out bit<8> tmp, in bit<8> val_1) {
                               ^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_side_effect_order_2-bmv2.p4(33): [--Wwarn=uninitialized_out_param] warning: out parameter 'tmp' may be uninitialized when 'do_thing' terminates
    action do_thing(out bit<8> tmp, in bit<8> val_1) {
                               ^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_side_effect_order_2-bmv2.p4(33)
    action do_thing(out bit<8> tmp, in bit<8> val_1) {
           ^^^^^^^^

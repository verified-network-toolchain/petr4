...
control ingress(inout Headers h, inout Meta m, inout standard_metadata_t sm) {
  apply
    {
    h.eth_hdr.eth_type =
    (h.eth_hdr.src_addr==5 ? reset(h.h.a) : reset(h.h.b));
  }
}
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_side_effects_in_mux-bmv2.p4(22): [--Wwarn=uninitialized_out_param] warning: out parameter 'hPSe' may be uninitialized when 'reset' terminates
bit<16> reset(out bit<8> hPSe) {
                         ^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/gauntlet_side_effects_in_mux-bmv2.p4(22)
bit<16> reset(out bit<8> hPSe) {
        ^^^^^

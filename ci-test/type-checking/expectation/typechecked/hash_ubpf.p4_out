/petr4/ci-test/type-checking/testdata/p4_16_samples/hash_ubpf.p4
\n
/*
...
control pipe(inout Headers_t headers, inout metadata meta,
  ...
  action a()
    {
    hash(meta.output, HashAlgorithm.lookup3,
           {headers.test.sa, headers.test.da});
  }
  action b()
    {
    hash(meta.output, HashAlgorithm.lookup3,
           {headers.test1.a, headers.test1.b, headers.test1.c,
             headers.test1.d});
  }
  action c() {
    hash(meta.output, HashAlgorithm.lookup3, {headers.test2.a});

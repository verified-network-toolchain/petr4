/petr4/ci-test/type-checking/testdata/p4_16_samples/issue-2123.p4
\n
/*
...
parser ParserImpl(packet_in packet, out headers hdr, inout metadata meta,
  ...
  state parse_ethernet
    {
    packet.extract(hdr=hdr.ethernet);
    transition select(hdr.ethernet.etherType, hdr.ethernet.srcAddr[7:0],
      hdr.ethernet.dstAddr[7:0]) {
      (2048 .. 2054, 8 .. 17, 8 .. 16): parse_ipv4;
      (2048, 8 .. 16, 6 &&& 17): parse_ipv4;
      default: accept;
    }
  }
  state parse_ipv4

/petr4/ci-test/type-checking/testdata/p4_16_samples/issue1406.p4
\n
#include <v1model.p4>
...
control TestEgress(inout headers_t hdr, inout metadata_t meta,
                   inout standard_metadata_t standard_metadata) {
  apply { 
  }
}
...
V1Switch(TestParser(), TestVerifyChecksum(), TestIngress(), TestEgress(),
           TestComputeChecksum(), TestDeparser())
  main;

************************\n******** p4c type checking result: ********\n************************\n
/petr4/ci-test/type-checking/testdata/p4_16_samples/issue1406.p4(17): [--Wwarn=parser-transition] warning: start: implicit transition to `reject'
  state start {
        ^^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/issue1406.p4(14): [--Wwarn=parser-transition] warning: accept state in parser TestParser is unreachable
parser TestParser(packet_in b, out headers_t headers, inout metadata_t meta,
       ^^^^^^^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/issue1406.p4(14): [--Wwarn=parser-transition] warning: accept state in parser TestParser is unreachable
parser TestParser(packet_in b, out headers_t headers, inout metadata_t meta,

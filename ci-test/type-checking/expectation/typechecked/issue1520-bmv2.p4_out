/petr4/ci-test/type-checking/testdata/p4_16_samples/issue1520-bmv2.p4
\n
#include <core.p4>
#include <v1model.p4>
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/issue1520-bmv2.p4(21): [--Wwarn=invalid_header] warning: accessing a field of an invalid header hdr.h
 hdr.h.x = 0;
 ^^^^^

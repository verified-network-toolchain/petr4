/petr4/ci-test/type-checking/testdata/p4_16_samples/issue1985.p4
\n
#include <core.p4>
#include <v1model.p4>
header h_t {
...
control c2(inout headers hdr, inout metadata meta,
           inout standard_metadata_t std_meta) {
  apply { 
  }
}
control c3(inout headers hdr, inout metadata meta,
           inout standard_metadata_t std_meta) {
  action a(in bool b) {
    hdr.h.x = 8w0;
  }
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/issue1985.p4(22): [--Wwarn=unused] warning: 'b' is unused
    action a(in bool b) {
                     ^

/petr4/ci-test/type-checking/testdata/p4_16_samples/issue2148.p4
\n
#include <core.p4>
#include <v1model.p4>
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/issue2148.p4(19): [--Wwarn=invalid_header] warning: accessing a field of an invalid header not_initialized
    if (not_initialized.a < 6) {
        ^^^^^^^^^^^^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/issue2148.p4(19): [--Wwarn=uninitialized_use] warning: not_initialized.a may be uninitialized
    if (not_initialized.a < 6) {
        ^^^^^^^^^^^^^^^^^

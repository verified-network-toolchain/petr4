/petr4/ci-test/type-checking/testdata/p4_16_samples/issue2289.p4
\n
#include <core.p4>
#include <v1model.p4>
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/issue2289.p4(44): [--Wwarn=unused] warning: 'byaA' is unused
    action simple_action(out bit<16> byaA) {
                                     ^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/issue2289.p4(44): [--Wwarn=uninitialized_out_param] warning: out parameter 'byaA' may be uninitialized when 'simple_action' terminates
    action simple_action(out bit<16> byaA) {
                                     ^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/issue2289.p4(44)
    action simple_action(out bit<16> byaA) {
           ^^^^^^^^^^^^^

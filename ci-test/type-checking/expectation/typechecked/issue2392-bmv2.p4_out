/petr4/ci-test/type-checking/testdata/p4_16_samples/issue2392-bmv2.p4
\n
#include <core.p4>
#include <v1model.p4>
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/issue2392-bmv2.p4(30): [--Wwarn=mismatch] warning: -8w1: negative value with unsigned type
        if (8w255 == -1) {
                      ^

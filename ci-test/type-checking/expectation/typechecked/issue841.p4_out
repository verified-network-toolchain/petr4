/petr4/ci-test/type-checking/testdata/p4_16_samples/issue841.p4
\n
#include <core.p4>
#include <v1model.p4>
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/issue841.p4(39): [--Wwarn=deprecated] warning: Checksum16: Using deprecated feature Checksum16. Please use verify_checksum/update_checksum instead.
    Checksum16() checksum;
    ^^^^^^^^^^
/petr4/ci-test/type-checking/p4include/v1model.p4(456)
extern Checksum16 {
       ^^^^^^^^^^

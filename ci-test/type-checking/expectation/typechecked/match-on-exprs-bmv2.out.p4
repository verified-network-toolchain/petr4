/petr4/ci-test/type-checking/testdata/p4_16_samples/match-on-exprs-bmv2.p4
\n
/*
...
control ingressImpl(inout headers_t hdr, inout metadata_t meta,
  ...
  table t1
    ...
    key =
      ...
      hdr.ethernet.srcAddr[22:18]: exact@name("ethernet.srcAddr.slice")
        ;
      hdr.ethernet.dstAddr & 1103823438081: exact@name("dstAddr_lsbs")
        ;
      hdr.ethernet.etherType-10: exact@name("etherType_less_10")
        ;
    }
    actions = {
      foo;my_drop;NoAction;
    }
    const default_action = NoAction;
  }
  apply {

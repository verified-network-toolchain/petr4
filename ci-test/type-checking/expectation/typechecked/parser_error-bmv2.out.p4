/petr4/ci-test/type-checking/testdata/p4_16_samples/parser_error-bmv2.p4
\n
#include <core.p4>
#include <v1model.p4>
...
control ingress(inout parsed_packet_t hdr,
  ...
  apply
    {
    if (standard_metadata.parser_error==PacketTooShort)
      {
      hdr.eth.setValid();
      hdr.eth.type = 0;
      hdr.eth.src = 0;
...
V1Switch(parse(), verify_checks(), ingress(), egress(), compute_checksum(),
           deparser())
  main;

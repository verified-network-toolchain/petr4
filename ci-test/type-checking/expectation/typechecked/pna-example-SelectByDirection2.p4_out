/petr4/ci-test/type-checking/testdata/p4_16_samples/pna-example-SelectByDirection2.p4
\n
/*
...
control MainControlImpl(inout headers_t hdr, inout main_metadata_t user_meta,
  ...
  apply
    ...
    if (hdr.ipv4.isValid())
      {
      forward(SelectByDirection(istd.direction, hdr.ipv4.srcAddr,
                hdr.ipv4.dstAddr));
      if (user_meta.meta==hdr.ipv4.dstAddr) {
        ipv4_da_lpm.apply();
      }

/petr4/ci-test/type-checking/testdata/p4_16_samples/predication_issue_1.p4
\n
#include <core.p4>
#include <v1model.p4>
...
action
  assign(inout bit<16> eth_t, inout bit<48> target_addr, bool check_bool)
  {
  if (check_bool) {
    if (simple_check() && 57005!=eth_t) {
      target_addr = 48w1;
    }
  }
}

/petr4/ci-test/type-checking/testdata/p4_16_samples/predication_issue_2.p4
\n
#include <core.p4>
#include <v1model.p4>
...
/petr4/ci-test/type-checking/testdata/p4_16_samples/predication_issue_2.p4(24): [--Wwarn=shadow] warning: 'bound' shadows 'bound'
bit<8> bound(in bit<8> val, in bit<8> bound) {
                                      ^^^^^
/petr4/ci-test/type-checking/testdata/p4_16_samples/predication_issue_2.p4(24)
bit<8> bound(in bit<8> val, in bit<8> bound) {
       ^^^^^

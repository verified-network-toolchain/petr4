/petr4/ci-test/type-checking/testdata/p4_16_samples/predication_issue_4.p4
\n
#include <core.p4>
#include <v1model.p4>
...
control ingress(inout Headers h, inout Meta m, inout standard_metadata_t sm) {
    bool bool_val = h.eth_hdr.eth_type == 0xDE;
    action perform_action() {
        if (bool_val) {
            h.h[get_bound(1w0, 1w1)].a = 8w1;
        }
    }
    apply {
        perform_action();
...
control ingress(inout Headers h, inout Meta m, inout standard_metadata_t sm) {
  bool bool_val = h.eth_hdr.eth_type==222;
  action perform_action() {
    if (bool_val) {
      h.h[get_bound(1w0, 1w1)].a = 8w1;
    }
...
[--Wwarn=mismatch] warning: 1w2: value does not fit in 1 bits
[--Wwarn=mismatch] warning: 1w2: value does not fit in 1 bits
[--Wwarn=mismatch] warning: 1w2: value does not fit in 1 bits

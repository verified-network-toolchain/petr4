/petr4/ci-test/type-checking/testdata/p4_16_samples/psa-counter3.p4
\n
#include <core.p4>
#include <bmv2/psa.p4>
...
extern DirectCounter<W> {
                     ^
/petr4/ci-test/type-checking/testdata/p4_16_samples/psa-counter3.p4(52): [--Wwarn=unused] warning: counter1: unused instance
    Counter<bit<10>,bit<12>>(1024, PSA_CounterType_t.PACKETS) counter1;
                                                              ^^^^^^^^

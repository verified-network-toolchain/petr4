/petr4/ci-test/type-checking/testdata/p4_16_samples/psa-example-dpdk-counter.p4
\n
#include <core.p4>
#include <dpdk/psa.p4>
...
parser MyIP(packet_in buffer, out headers_t hdr, inout EMPTY b,
...
control MyIC(inout headers_t hdr, inout EMPTY b,
...
control MyID(packet_out buffer, out EMPTY a, out EMPTY b, out EMPTY c,
             inout headers_t hdr, in EMPTY e,

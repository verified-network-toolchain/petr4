/petr4/ci-test/type-checking/testdata/p4_16_samples/ubpf_checksum_extern.p4
\n
#include <core.p4>
...
extern bit<16> incremental_checksum(in bit<16> csum, in bit<32> old,
                                    in bit<32> new);
extern bool verify_ipv4_checksum(in IPv4_h iphdr);
...
control pipe(inout Headers_t headers, inout metadata meta,
  ...
  apply
    ...
    if (verified==true)
      ...
      incremental_checksum(headers.ipv4.hdrChecksum, old_addr,

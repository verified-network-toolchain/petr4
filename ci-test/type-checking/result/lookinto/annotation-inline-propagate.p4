/petr4/ci-test/type-checking/testdata/p4_16_samples/annotation-inline-propagate.p4
\n
...
@my_anno_1
  @name("inner_parser")
  parser InnerParser(packet_in buffer, out hdr_t a) {
  state start {
    buffer.extract(a);
    transition accept;
  }
...
@my_anno_2
  @name("outer_parser")
  parser MyParser(packet_in buffer, out headers hdr, inout metadata meta,
                  inout standard_metadata_t standard_metadata) {
  InnerParser() inner;
  state start {
    inner.apply(buffer, hdr.hdr);

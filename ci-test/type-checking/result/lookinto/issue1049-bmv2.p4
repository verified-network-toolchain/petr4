/petr4/ci-test/type-checking/testdata/p4_16_samples/issue1049-bmv2.p4
\n
/*
...
control cIngress(inout headers hdr, inout metadata meta,
  ...
  action hash_drop_decision()
    ...
    hash(meta.mystruct1.hash1, HashAlgorithm.crc16, (bit<16>) 0,
           {hdr.ipv4.srcAddr, hdr.ipv4.dstAddr, hdr.ipv4.protocol},
           (bit<32>) 65535);
    meta.mystruct1.hash_drop = meta.mystruct1.hash1<32768;
  }
  table guh
    {
    key = {
  ...
  apply
    ...
    if (hdr.ipv4.isValid())
      ...
      if (meta.mystruct1.hash_drop)
        ...
        meta.mystruct1.hash1 ++ 7w0 ++ (bit<1>) meta.mystruct1.hash_drop ++ 8w0 ++ 16w57005;
      }else
      {
      hdr.ethernet.dstAddr =
      meta.mystruct1.hash1 ++ 7w0 ++ (bit<1>) meta.mystruct1.hash_drop ++ 8w0 ++ 16w49153;
      }
    }
  }
}
...
V1Switch<headers, metadata>(parserI(), verifyChecksum(), cIngress(),
                              cEgress(), updateChecksum(), DeparserI())
  main;

/petr4/ci-test/type-checking/testdata/p4_16_samples/issue430-1-bmv2.p4
\n
/*
...
control cIngress(inout Parsed_packet hdr, inout Metadata meta,
                 inout standard_metadata_t stdmeta) {
  apply {
    digest(5, {hdr.ethernet.srcAddr});
    hdr.ethernet.srcAddr = 0;
...
control cEgress(inout Parsed_packet hdr, inout Metadata meta,
                inout standard_metadata_t stdmeta) {
  apply { 
  }
}

/petr4/ci-test/type-checking/testdata/p4_16_samples/named_meter_1-bmv2.p4
\n
/*
...
control ingress(inout headers hdr, inout metadata meta,
  ...
  @name("m_action")
  action m_action(bit<9> meter_idx)
    {
    standard_metadata.egress_spec = meter_idx;
    standard_metadata.egress_spec = 9w1;
  }
  ...
  @name("m_action")
  action m_action_0(bit<9> meter_idx)
    {
    standard_metadata.egress_spec = meter_idx;
    my_meter.read(meta.meta.meter_tag);
  }

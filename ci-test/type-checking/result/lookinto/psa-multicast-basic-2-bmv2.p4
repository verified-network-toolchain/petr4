/petr4/ci-test/type-checking/testdata/p4_16_samples/psa-multicast-basic-2-bmv2.p4
\n
/*
...
control cIngress(inout headers_t hdr, inout metadata_t user_meta,
  ...
  apply
    ...
    (ClassOfService_t) (ClassOfServiceUint_t) hdr.ethernet.srcAddr[0:0];
  }
}
...
control cEgress(inout headers_t hdr, inout metadata_t user_meta,
  ...
  apply
    ...
    hdr.output_data.word1 = (bit<32>) (EgressInstanceUint_t) istd.instance;
    packet_path_to_int.apply(istd.packet_path, hdr.output_data.word2);
    hdr.output_data.word3 =
    (bit<32>) (ClassOfServiceUint_t) istd.class_of_service;
  }
}

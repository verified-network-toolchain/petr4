/petr4/ci-test/type-checking/testdata/p4_16_samples/table-entries-ternary-bmv2.p4
\n
/*
...
control ingress(inout Header_t h, inout Meta_t m,
  ...
  table t_ternary
    ...
    const entries =
      {
      4369 &&& 15: a_with_control_params(1);
      4487: a_with_control_params(2);
      4369 &&& 61440: a_with_control_params(3);
      _: a_with_control_params(4);
    }
  }
  apply {

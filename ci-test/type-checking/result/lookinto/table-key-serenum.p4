/petr4/ci-test/type-checking/testdata/p4_16_samples/table-key-serenum.p4
\n
#include <v1model.p4>
...
control c(inout Headers h, inout standard_metadata_t sm) {
  ...
  table tns
    ...
    const entries =
      {
      EthTypes.IPv4: do_act(2048);
      EthTypes.VLAN: do_act(33024);
    }
  }
  apply {
    tns.apply();
...
parser p<H34> (packet_in _p, out H34 h);
control ctr<H35, SM> (inout H35 h, inout SM sm);
package top<H36, SM37> (p<H36> _p, ctr<H36, SM37> _c);
top(prs(), c()) main;

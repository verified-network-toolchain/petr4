/petr4/ci-test/type-checking/testdata/p4_16_samples/v1model-const-entries-bmv2.p4
\n
/*
...
control ingressImpl(inout headers_t hdr, inout metadata_t meta,
                    inout standard_metadata_t stdmeta) {
  action act_miss() {
    hdr.ethernet.srcAddr = 3735928559;
  }
  action act_hit(bit<48> x) {
    hdr.ethernet.srcAddr = x;
  }
  table lpm1
    ...
    const entries =
      {
      10999444996096 &&& 281474976710655: act_hit(1);
      10995116277760 &&& 280375465082880: act_hit(2);
      0 &&& 0: act_hit(3);
    }
    const default_action = act_miss();
  }

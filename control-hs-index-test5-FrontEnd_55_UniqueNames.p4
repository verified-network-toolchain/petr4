...
control ingress(inout headers h, inout Meta m, inout standard_metadata_t sm) {
    ...
    @name("stats") counter(32w65536, CounterType.packets) stats;
    @name("add") action add_0(@name("hs") inout h_stack hs_0, @name("i") in bit<32> i_0) {
        hs_0.a = hs_0.a + i_0;
    }
    apply {
        tmp_1 = h.i.index;
        add_0(h.h[tmp_1], 32w0xff);
        tmp_2 = h.i.index;
        stats.count(h.h[tmp_2].a);
    }
}

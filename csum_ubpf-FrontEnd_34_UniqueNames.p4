...
control pipe(inout Headers_t headers, inout metadata meta, inout standard_metadata std_meta) {
    apply {
        @name("old_addr") bit<32> old_addr_0 = headers.ipv4.dstAddr;
        @name("new_addr") bit<32> new_addr_0 = 32w0x1020304;
        headers.ipv4.dstAddr = new_addr_0;
        headers.ipv4.checksum = csum_replace4(headers.ipv4.checksum, old_addr_0, new_addr_0);
        @name("from") bit<16> from_0 = headers.udp.dstPort;
        @name("to") bit<16> to_0 = 16w0x400;

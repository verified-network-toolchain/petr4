...
(** val coq_ValueBase_rect :
    ...
    -> 'a2) -> ('a1 coq_ValueBase list -> int -> int -> 'a2) -> ('a1 t -> 'a1
    t -> 'a2) -> ('a1 t -> 'a1 t -> 'a1 coq_ValueBase -> 'a2 -> 'a2) -> (('a1
...
(** val coq_Declaration_rect :
    ...
    -> 'a1 coq_P4Type -> 'a1 t -> ('a1 t * 'a1 coq_Expression) list -> 'a2)
...
(** val coq_ValueObject_rect :
    ...
    coq_P4Parameter list -> 'a1 coq_P4Parameter list -> 'a1 coq_Declaration
    list -> 'a1 coq_Block -> 'a2) -> (('a1 t * 'a1 coq_ValueLoc) list -> 'a2)
    -> ('a1 coq_ValueLoc -> 'a1 t -> 'a2) -> ('a1 coq_P4Parameter list -> 'a1
    coq_ValueFunctionImplementation -> 'a2) -> ('a1 coq_Env_EvalEnv -> 'a1
    coq_P4Parameter list -> 'a1 coq_Block -> 'a2) -> (bool list -> 'a2) ->
...
(** val coq_ValueConstructor_rect :
    ...
    ('a1 coq_ValueTable -> 'a2) -> ('a1 coq_Env_EvalEnv -> 'a1
    coq_P4Parameter list -> 'a1 coq_P4Parameter list -> 'a1 coq_Declaration
    list -> 'a1 coq_Block -> 'a2) -> ('a1 coq_P4Parameter list -> ('a1
    t * 'a1 coq_ValueLoc) list -> 'a2) -> (('a1 t * 'a1 coq_P4Parameter list)
    list -> 'a2) -> 'a1 coq_ValueConstructor -> 'a2 **)
...
let coq_Value_rect f f0 f1 f2 = function
| ValBase x -> f x
| ValObj x -> f0 x
| ValCons x -> f1 x
| ValLvalue x -> f2 x
...
let coq_Value_rec f f0 f1 f2 = function
| ValBase x -> f x
| ValObj x -> f0 x
| ValCons x -> f1 x
| ValLvalue x -> f2 x

...
| ValBaseRecord of ('tags_t t * 'tags_t coq_ValueBase) list
| ValBaseSet of 'tags_t coq_ValueSet
| ValBaseError of 'tags_t t
| ValBaseMatchKind of 'tags_t t
| ValBaseStruct of ('tags_t t * 'tags_t coq_ValueBase) list
| ValBaseHeader of ('tags_t t * 'tags_t coq_ValueBase) list * bool
| ValBaseUnion of ('tags_t t * 'tags_t coq_ValueBase) list
...
| ValBaseSenum of ('tags_t t * 'tags_t coq_ValueBase) list
...
val coq_ValueBase_rect :
  ...
  'a2) -> ('a1 coq_ValueBase list -> 'a2) -> (('a1 t * 'a1 coq_ValueBase)
  list -> 'a2) -> ('a1 coq_ValueSet -> 'a2) -> ('a1 t -> 'a2) -> ('a1 t ->
  'a2) -> (('a1 t * 'a1 coq_ValueBase) list -> 'a2) -> (('a1 t * 'a1
  coq_ValueBase) list -> bool -> 'a2) -> (('a1 t * 'a1 coq_ValueBase) list ->
  'a2) -> ('a1 coq_ValueBase list -> int -> int -> 'a2) -> ('a1 t -> 'a1 t ->
  'a2) -> ('a1 t -> 'a1 t -> 'a1 coq_ValueBase -> 'a2 -> 'a2) -> (('a1
  t * 'a1 coq_ValueBase) list -> 'a2) -> 'a1 coq_ValueBase -> 'a2
...
| DeclSerializableEnum of 'tags_t * 'tags_t coq_P4Type * 'tags_t t
   * ('tags_t t * 'tags_t coq_Expression) list
...
val coq_Declaration_rect :
  ...
  coq_P4Type -> 'a1 t -> ('a1 t * 'a1 coq_Expression) list -> 'a2) -> ('a1 ->
  'a1 t -> 'a1 t list -> 'a1 coq_MethodPrototype list -> 'a2) -> ('a1 -> 'a1
  t -> ('a1 coq_P4Type, 'a1 coq_Declaration) sum -> 'a2) -> ('a1 -> 'a1 t ->
  ('a1 coq_P4Type, 'a1 coq_Declaration) sum -> 'a2) -> ('a1 -> 'a1 t -> 'a1 t
  list -> 'a1 coq_P4Parameter list -> 'a2) -> ('a1 -> 'a1 t -> 'a1 t list ->
  'a1 coq_P4Parameter list -> 'a2) -> ('a1 -> 'a1 t -> 'a1 t list -> 'a1
  coq_P4Parameter list -> 'a2) -> 'a1 coq_Declaration -> 'a2
...
type ('tags_t, 'binding) coq_Env_env = ('tags_t t * 'binding) list list
...
| ValObjControl of 'tags_t coq_Env_EvalEnv * 'tags_t coq_P4Parameter list
   * 'tags_t coq_P4Parameter list * 'tags_t coq_Declaration list
   * 'tags_t coq_Block
| ValObjPackage of ('tags_t t * 'tags_t coq_ValueLoc) list
...
val coq_ValueObject_rect :
  ...
  coq_Block -> 'a2) -> (('a1 t * 'a1 coq_ValueLoc) list -> 'a2) -> ('a1
...
| ValConsPackage of 'tags_t coq_P4Parameter list
   * ('tags_t t * 'tags_t coq_ValueLoc) list
| ValConsExternObj of ('tags_t t * 'tags_t coq_P4Parameter list) list
...
val coq_ValueConstructor_rect :
  ...
  ('a1 coq_ValueTable -> 'a2) -> ('a1 coq_Env_EvalEnv -> 'a1 coq_P4Parameter
  list -> 'a1 coq_P4Parameter list -> 'a1 coq_Declaration list -> 'a1
  coq_Block -> 'a2) -> ('a1 coq_P4Parameter list -> ('a1 t * 'a1
  coq_ValueLoc) list -> 'a2) -> (('a1 t * 'a1 coq_P4Parameter list) list ->
  'a2) -> 'a1 coq_ValueConstructor -> 'a2
...
| ValLvalue of 'tags_t coq_ValueLvalue

val coq_Value_rect :
  ('a1 coq_ValueBase -> 'a2) -> ('a1 coq_ValueObject -> 'a2) -> ('a1
  coq_ValueConstructor -> 'a2) -> ('a1 coq_ValueLvalue -> 'a2) -> 'a1
  coq_Value -> 'a2

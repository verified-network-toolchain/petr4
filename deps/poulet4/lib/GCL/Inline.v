...
Definition translate_simple_patterns pat tags : result E.e :=
  match pat with
  | Parser.PATBit w v =>
    ok (E.Bit w v tags)
  | Parser.PATInt w v =>
...
Program Fixpoint translate_pat tags e pat { struct pat } : result E.e  :=
...
Fixpoint inline_state
         ...
         (tags :)
  : result ((list (string * Parser.state_block)) * t) :=
  match gas with
  | O => ok ([], ISkip tags)
  | S gas =>
...
Definition elim_tuple_assign (ltyp : E.t) (lhs rhs : E.e) (i :) : result Inline.t :=
  match lhs, rhs with
...
Definition header_elaboration_assign tags (lhs rhs : E.e) (fields : F.fs string E.t) : result t:=
...
Definition elaborate_extract extern (arrow : E.arrowE) (tags :) : result Inline.t :=
...
Fixpoint header_asserts (e : E.e) (tags :) : result t :=
  match e with

...
Definition header_elaboration_assign  (lhs rhs : E.e) (fields : list E.t) : result t:=
...
Definition elaborate_extract extern args ret  : result Inline.t :=
  match args with
  | [(hdr, (PAOut arg))] =>
    (*match arg with
...
Fixpoint elaborate_arrays (c : Inline.t) : result Inline.t :=
  match c with
  | ISkip => ok c
  | IVardecl type x =>
    match type with

...
Definition matchrow_inner (table : string) (n : nat) (elt : nat * BV.t * string) (acc_res : result F.t) : result F.t :=
  let (te, mk) := elt in
  let (w, k) := te in
...
Definition matchrow (table : string) (keys : list (nat * BV.t * string)) : result F.t :=
...
Definition action_inner (table : string) (keys : list (nat * BV.t * string)) (w : nat) (n : nat) (named_action : string * ToGCL.target) (res_acc : result (ToGCL.target)) : result ToGCL.target :=
...
Definition actions_encoding (table : string) (keys : list (nat * BV.t * string)) (actions : list (string * ToGCL.target)) : result ToGCL.target :=

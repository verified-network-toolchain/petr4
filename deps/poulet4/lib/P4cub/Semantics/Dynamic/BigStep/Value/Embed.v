...
Section Embed.
  ...
  | TStruct_not_header (types : list Expr.t) (light_types : list P_P4Type) : 
    ...
    P4Cub_to_P4Light (Expr.TStruct types false) (TypTuple (light_types))
  | TStruct_header (types : list Expr.t) (light_types : P4String.AList tags_t P4Type) : 
    Forall2 P4Cub_to_P4Light types (map snd light_types) -> 
    P4Cub_to_P4Light (Expr.TStruct types true) (TypHeader (light_types)) 
  ...
  Fixpoint embed (v : Val.v) : VAL :=
    ...
    | Val.Struct (vs) (Some b)     => ValBaseTuple $ map embed vs
    | { STRUCT { vs } } =>
      ValBaseStruct

...
Import AllCubNotations Clmt.Notations Val.ValueNotations Step.
...
Section Correct.
  ...
  Definition epsilon_env (eps : epsilon) (env : VarNameGen.t) : Prop :=
    forall n, env <= n -> eps (fst (VarNameGen.new_var n)) = None.
  ...
  Proof.
    ...
    - solve_this_stuff_with eps ~{ w VW n }~.
      ...
      + apply Clmt.find_none_bind_sub_env.
        apply Hee. lia.
      + intros k Hk.
        unfold VarNameGen.new_var, fst in *.
        rewrite Clmt.bind_complete.
        * apply Hee. lia.
        * intros Hwah.

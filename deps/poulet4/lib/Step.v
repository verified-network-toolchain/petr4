...
Section Step.
  ...
  Definition step (p: (ValueParser tags_t)) (start: string) : env_monad tags_t string := 
    let 'MkValueParser _ env params cparams locals states := p in
   ...
   *)
  Fixpoint step_trans (p: ValueParser tags_t) (fuel: nat) (start: string) : env_monad tags_t unit := 
    match fuel with 

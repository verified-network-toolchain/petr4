 ...
 sig
   ...
   sig
    module E :
     sig
      ...
      type 'tags_t constructor_arg = 'tags_t Expr.constructor_arg =
      | CAExpr of 'tags_t e
      | CAName of string
  ...
  module TopDecl :
   sig
    ...
    module C :
     sig
      type 'tags_t table = 'tags_t Control.ControlDecl.table =
      ...
      type 'tags_t d = 'tags_t Control.ControlDecl.d =
    ...
    module P :
     sig
      ...
      type 'tags_t state_block = 'tags_t Parser.state_block =
      | State of 'tags_t S.s * 'tags_t e

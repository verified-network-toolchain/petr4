...
val add_temp_nameless : coq_ClightEnv -> coq_type -> coq_ClightEnv * ident
...
val add_function : coq_ClightEnv -> string -> coq_function -> coq_ClightEnv

val update_function : coq_ClightEnv -> string -> coq_function -> coq_ClightEnv

val new_ident : coq_ClightEnv -> coq_ClightEnv * ident

val find_ident : coq_ClightEnv -> string -> ident option

val find_ident_temp_arg : coq_ClightEnv -> string -> (ident * ident) option

val lookup_composite_rec :
  (E.t * composite_definition) list -> E.t -> composite_definition option

val lookup_composite : coq_ClightEnv -> E.t -> composite_definition option

val lookup_function : coq_ClightEnv -> string -> (coq_function * ident) option

val get_vars : coq_ClightEnv -> (ident * coq_type) list

val get_temps : coq_ClightEnv -> (ident * coq_type) list

val get_functions : coq_ClightEnv -> (ident * coq_function) list option

...
\newcommand{\expenvNoTrans}[2]{\Gamma \vdash {#1} : {#2}}
\newcommand{\expenvForWorkshop}[2]{\Gamma \vdash {#1} \leadsto {#2}}
...
\newcommand{\typeEq}[2]{{#1} ==_\env {#2}}%for p4 workshop
...
\newcommand{\notInstantiated}{\mathsf{not\_instantiated}}

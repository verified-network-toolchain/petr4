...
\newcommand*{\methodCallS}{\rn{MethodCall}\rS}
\newcommand*{\assignmentS}{\rn{Assignment}\rS}
\newcommand*{\dirAppS}{\rn{DirectApplication}\rS}
\newcommand*{\emptyS}{\rn{Empty}\rS}
\newcommand*{\blockS}{\rn{Block}\rS}
\newcommand*{\returnS}{\rn{ReturnExpression}\rS}
\newcommand*{\returnEmpS}{\rn{Return}\rS}
...
\newcommand*{\switchS}{\rn{Switch}\rSep\rn{EnumOrInteger}\rS}
\newcommand*{\switchActionS}{\rn{Switch}\rSep\rn{ActionRun}\rS}
\newcommand*{\constantS}{\rn{Constant}\rS}
\newcommand*{\instantiationS}{\rn{Instantiation}\rSep\rn{1}\rS}
\newcommand*{\instantiationNoBlockS}{\rn{Instantiation}\rSep\rn{2}\rS}
\newcommand*{\varS}{\rn{Variable}\rS}
\newcommand*{\varInitS}{\rn{VariableInit}\rS}
...
\newcommand{\stmtCheck}[4]{{#1} \vdash {#2} : {#3} \dashv {#4}}
...
\newcommand{\isntParserOrFunc}[1]{\mathit{isnt\_parser\_or\_function}({#1})}
\newcommand{\isntParser}[1]{\mathit{isnt\_parser}({#1})}
\newcommand{\validStmtCtxt}[1]{\mathit{valid\_statement\_context}({#1})}
\newcommand{\typCtxt}[1]{\mathit{type\_of\_context}({#1})}
% parameter context
...
\newcommand{\actionRun}[1]{{#1}.\mathit{apply}().\mathsf{action\_run}}
\newcommand{\isTableAction}[2]{\mathit{is\_table\_action}({#1}, {#2})}
\newcommand{\defaultLast}[1]{\mathit{default\_is\_last}({#1})}
\newcommand{\labels}[1]{\mathit{labels}({#1})}
\newcommand{\labelMatchTyp}[2]{\mathit{label\_match\_type}({#1},{#2})}
\newcommand{\blockSwitch}[1]{\mathit{block}({#1})}
...
\newcommand{\isEnumOrIntOrErr}[1]{\mathit{is\_enum\_or\_int\_or\_err}({#1})}
...
\newcommand{\matchParamsArgs}[2]{\mathit{macth\_parameters\_arguments}(\overline {#1}, \overline{#2})}
\newcommand{\resolveOverload}[2]{\mathit{resolve\_overload}(\overline {#1}, \overline {#2})}
\newcommand{\validParamsArgs}[2]{\mathit{valid\_parameters\_arguments}(\overline{#1})_{#2}}
...
% type helpers
\newcommand{\subTypVars}[2]{\mathit{sub\_type\_vars}({#1})_{#2}}

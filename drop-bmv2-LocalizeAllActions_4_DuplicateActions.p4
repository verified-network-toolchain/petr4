...
@name(".drop") action drop(@name("smeta") inout standard_metadata_t smeta_0) {
    mark_to_drop(smeta_0);
}
control IngressI(inout H hdr, inout M meta, inout standard_metadata_t smeta) {
    @name(".drop") action drop_0(@name("smeta") inout standard_metadata_t smeta_0) {
        mark_to_drop(smeta_0);
    }
    @name(".drop") action drop_1(@name("smeta") inout standard_metadata_t smeta_0) {
        mark_to_drop(smeta_0);
    }

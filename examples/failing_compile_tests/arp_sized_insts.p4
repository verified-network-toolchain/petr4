...
const bit<8>  IPPROTO_ICMP   = 8w0x01;
...
const bit<16> ARP_HTYPE_ETHERNET = 16w0x0001;
const bit<16> ARP_PTYPE_IPV4     = 16w0x0800;
const bit<8>  ARP_HLEN_ETHERNET   = 8w6;
const bit<8>  ARP_PLEN_IPV4      = 8w4;
const bit<16> ARP_OPER_REQUEST   = 16w1;
const bit<16> ARP_OPER_REPLY     = 16w2;
...
const bit<8> ICMP_ECHO_REQUEST = 8w8;
const bit<8> ICMP_ECHO_REPLY   = 8w0;

...
control FabricIngress(inout parsed_headers_t hdr, inout fabric_metadata_t fabric_metadata, inout standard_metadata_t standard_metadata) {
    @name("spgw_normalizer.hasReturned") bool spgw_normalizer_hasReturned;
    @name("spgw_ingress.hasReturned_0") bool spgw_ingress_hasReturned;
    ...
    @hidden @name("spgw_ingress.gtpu_decap") action spgw_ingress_gtpu_decap_0() {
        hdr.gtpu_ipv4.setInvalid();
        hdr.gtpu_udp.setInvalid();
        hdr.gtpu.setInvalid();
    }
    @name("spgw_ingress.set_dl_sess_info") action spgw_ingress_set_dl_sess_info_0(@name("teid") bit<32> teid_1, @name("s1u_enb_addr") bit<32> s1u_enb_addr_1, @name("s1u_sgw_addr") bit<32> s1u_sgw_addr_1) {
    ...
    @name("filtering.deny") action filtering_deny_0() {
        fabric_metadata.skip_forwarding = true;
        fabric_metadata.skip_next = true;
        filtering_ingress_port_vlan_counter.count();
    }
    @name("filtering.permit") action filtering_permit_0() {
        filtering_ingress_port_vlan_counter.count();
    }
    @name("filtering.permit_with_internal_vlan") action filtering_permit_with_internal_vlan_0(@name("vlan_id") vlan_id_t vlan_id_2) {
    ...
    @name("filtering.set_forwarding_type") action filtering_set_forwarding_type_0(@name("fwd_type") fwd_type_t fwd_type_1) {
    ...
    @name("forwarding.set_next_id_bridging") action forwarding_set_next_id_bridging_0(@name("next_id") next_id_t next_id_0) {
        @hidden {
    ...
    @name("forwarding.pop_mpls_and_next") action forwarding_pop_mpls_and_next_0(@name("next_id") next_id_t next_id_6) {
    ...
    @name("forwarding.set_next_id_routing_v4") action forwarding_set_next_id_routing_v4_0(@name("next_id") next_id_t next_id_7) {
        @hidden {
            fabric_metadata.next_id = next_id_7;
        }
        forwarding_routing_v4_counter.count();
    }
    @name("forwarding.nop_routing_v4") action forwarding_nop_routing_v4_0() {
        forwarding_routing_v4_counter.count();
    }
    ...
    @name("acl.set_next_id_acl") action acl_set_next_id_acl_0(@name("next_id") next_id_t next_id_8) {
        fabric_metadata.next_id = next_id_8;
        acl_acl_counter.count();
    }
    @name("acl.punt_to_cpu") action acl_punt_to_cpu_0() {
        standard_metadata.egress_spec = 9w255;
        fabric_metadata.skip_next = true;
        acl_acl_counter.count();
    }
    @name("acl.clone_to_cpu") action acl_clone_to_cpu_0() {
        fabric_metadata.clone_to_cpu = true;
        acl_acl_counter.count();
    }
    @name("acl.drop") action acl_drop_0() {
        mark_to_drop(standard_metadata);
        fabric_metadata.skip_next = true;
        acl_acl_counter.count();
    }
    @name("acl.nop_acl") action acl_nop_acl_0() {
        acl_acl_counter.count();
    }
    ...
    @name("next.set_vlan") action next_set_vlan_0(@name("vlan_id") vlan_id_t vlan_id_3) {
    ...
    @name("next.output_xconnect") action next_output_xconnect_0(@name("port_num") port_num_t port_num) {
        @hidden {
            standard_metadata.egress_spec = port_num;
        }
        next_xconnect_counter.count();
    }
    @name("next.set_next_id_xconnect") action next_set_next_id_xconnect_0(@name("next_id") next_id_t next_id_9) {
    ...
    @name("next.output_hashed") action next_output_hashed_0(@name("port_num") port_num_t port_num_0) {
        @hidden {
            standard_metadata.egress_spec = port_num_0;
        }
        next_hashed_counter.count();
    }
    @name("next.routing_hashed") action next_routing_hashed_0(@name("port_num") port_num_t port_num_1, @name("smac") mac_addr_t smac, @name("dmac") mac_addr_t dmac) {
        @hidden {
            @hidden {
    ...
    @name("next.mpls_routing_hashed") action next_mpls_routing_hashed_0(@name("port_num") port_num_t port_num_2, @name("smac") mac_addr_t smac_0, @name("dmac") mac_addr_t dmac_0, @name("label") mpls_label_t label_0) {
        @hidden {
            @hidden {
    ...
    @name("next.set_mcast_group_id") action next_set_mcast_group_id_0(@name("group_id") mcast_group_id_t group_id) {
...
control FabricEgress(inout parsed_headers_t hdr, inout fabric_metadata_t fabric_metadata, inout standard_metadata_t standard_metadata) {
    ...
    @hidden @name("spgw_egress.gtpu_encap") action spgw_egress_gtpu_encap_0() {
    ...
    @hidden @name("egress_next.pop_mpls_if_present") action egress_next_pop_mpls_if_present_0() {
        hdr.mpls.setInvalid();
        fabric_metadata.eth_type = fabric_metadata.ip_eth_type;
    }
    @hidden @name("egress_next.set_mpls") action egress_next_set_mpls_0() {
        hdr.mpls.setValid();
    ...
    @hidden @name("egress_next.push_vlan") action egress_next_push_vlan_0() {
    ...
    @name("egress_next.pop_vlan") action egress_next_pop_vlan_0() {

...
control FabricIngress(inout parsed_headers_t hdr, inout fabric_metadata_t fabric_metadata, inout standard_metadata_t standard_metadata) {
    ...
    @name("spgw_ingress.set_dl_sess_info") action spgw_ingress_set_dl_sess_info_0(@name("teid") bit<32> teid_0, @name("s1u_enb_addr") bit<32> s1u_enb_addr_0, @name("s1u_sgw_addr") bit<32> s1u_sgw_addr_0) {
        fabric_metadata.spgw.teid = teid_0;
        fabric_metadata.spgw.s1u_enb_addr = s1u_enb_addr_0;
        fabric_metadata.spgw.s1u_sgw_addr = s1u_sgw_addr_0;
        spgw_ingress_ue_counter.count();
    ...
    @name("filtering.permit_with_internal_vlan") action filtering_permit_with_internal_vlan_0(@name("vlan_id") vlan_id_t vlan_id_0) {
        fabric_metadata.vlan_id = vlan_id_0;
        filtering_ingress_port_vlan_counter.count();
    }
    ...
    @name("filtering.set_forwarding_type") action filtering_set_forwarding_type_0(@name("fwd_type") fwd_type_t fwd_type_0) {
        fabric_metadata.fwd_type = fwd_type_0;
        filtering_fwd_classifier_counter.count();
    }
    ...
    @name("forwarding.set_next_id_bridging") action forwarding_set_next_id_bridging_0(@name("next_id") next_id_t next_id_1) {
        @hidden {
            fabric_metadata.next_id = next_id_1;
        }
        forwarding_bridging_counter.count();
    ...
    @name("forwarding.pop_mpls_and_next") action forwarding_pop_mpls_and_next_0(@name("next_id") next_id_t next_id_2) {
        fabric_metadata.mpls_label = 20w0;
        @hidden {
            fabric_metadata.next_id = next_id_2;
        }
    ...
    @name("forwarding.set_next_id_routing_v4") action forwarding_set_next_id_routing_v4_0(@name("next_id") next_id_t next_id_3) {
        @hidden {
            fabric_metadata.next_id = next_id_3;
        }
        forwarding_routing_v4_counter.count();
    ...
    @name("acl.set_next_id_acl") action acl_set_next_id_acl_0(@name("next_id") next_id_t next_id_4) {
        fabric_metadata.next_id = next_id_4;
        acl_acl_counter.count();
    }
    ...
    @name("next.set_vlan") action next_set_vlan_0(@name("vlan_id") vlan_id_t vlan_id_1) {
        fabric_metadata.vlan_id = vlan_id_1;
        next_next_vlan_counter.count();
    }
    ...
    @name("next.output_xconnect") action next_output_xconnect_0(@name("port_num") port_num_t port_num_3) {
        @hidden {
            standard_metadata.egress_spec = port_num_3;
        }
        next_xconnect_counter.count();
    ...
    @name("next.set_next_id_xconnect") action next_set_next_id_xconnect_0(@name("next_id") next_id_t next_id_5) {
        fabric_metadata.next_id = next_id_5;
        next_xconnect_counter.count();
    }
    ...
    @name("next.output_hashed") action next_output_hashed_0(@name("port_num") port_num_t port_num_4) {
        @hidden {
            standard_metadata.egress_spec = port_num_4;
        }
        next_hashed_counter.count();
    ...
    @name("next.routing_hashed") action next_routing_hashed_0(@name("port_num") port_num_t port_num_5, @name("smac") mac_addr_t smac_3, @name("dmac") mac_addr_t dmac_3) {
        @hidden {
            @hidden {
                hdr.ethernet.src_addr = smac_3;
            }
    ...
    @name("next.mpls_routing_hashed") action next_mpls_routing_hashed_0(@name("port_num") port_num_t port_num_6, @name("smac") mac_addr_t smac_4, @name("dmac") mac_addr_t dmac_4, @name("label") mpls_label_t label_2) {
        @hidden {
            @hidden {
                fabric_metadata.mpls_label = label_2;
            }
    ...
    @name("next.set_mcast_group_id") action next_set_mcast_group_id_0(@name("group_id") mcast_group_id_t group_id_0) {
        standard_metadata.mcast_grp = group_id_0;
        fabric_metadata.is_multicast = true;
        next_multicast_counter.count();
    }

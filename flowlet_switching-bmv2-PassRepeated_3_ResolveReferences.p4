...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name("set_ecmp_select") action set_ecmp_select_0(@name("ecmp_base") bit<8> ecmp_base_0, @name("ecmp_count") bit<8> ecmp_count_0) {
    ...
    @name("set_nhop") action set_nhop_0(@name("nhop_ipv4") bit<32> nhop_ipv4_0, @name("port") bit<9> port_0) {
    ...
    @name("set_dmac") action set_dmac_0(@name("dmac") bit<48> dmac_0) {

...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name("set_ecmp_select") action set_ecmp_select_0(@name("ecmp_base") bit<8> ecmp_base, @name("ecmp_count") bit<8> ecmp_count) {
    ...
    @name("set_nhop") action set_nhop_0(@name("nhop_ipv4") bit<32> nhop_ipv4_1, @name("port") bit<9> port) {
    ...
    @name("set_dmac") action set_dmac_0(@name("dmac") bit<48> dmac) {

...
control ingress(inout Headers h, inout Meta m, inout standard_metadata_t sm) {
    @name("tmp_hdr") ethernet_t tmp_hdr_0 = (ethernet_t){dst_addr = 48w0,src_addr = 48w0,eth_type = 16w0};
    @name("ref_hdr") ethernet_t ref_hdr_0 = h.eth_hdr;
    apply {
        ref_hdr_0.dst_addr = tmp_hdr_0.src_addr;
    }
}

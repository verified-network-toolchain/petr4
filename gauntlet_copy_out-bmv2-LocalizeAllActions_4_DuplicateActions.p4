...
control ingress(inout Headers h, inout Meta m, inout standard_metadata_t sm) {
    @name("c") bit<8> c_0;
    @name("do_thing") action do_thing_0(@name("inout_c") inout bit<8> inout_c_0) {
        h.h.a = inout_c_0;
    }
    @name("do_thing") action do_thing(@name("inout_c") inout bit<8> inout_c_0) {
        h.h.a = inout_c_0;
    }
    @name("do_thing") action do_thing_1(@name("inout_c") inout bit<8> inout_c_0) {
        h.h.a = inout_c_0;
    }
    apply {
        c_0 = 8w12;

...
control ingress(inout Headers h, inout Meta m, inout standard_metadata_t sm) {
    @name("simple_table_2") table simple_table {
        key = {
    ...
    apply {
        @name("simple_eq") bool simple_eq_0 = h.eth_hdr.eth_type == 16w1;
        @name("assign") bit<16> assign_0 = (simple_eq_0 || simple_table.apply().hit ? 16w2 : 16w3);

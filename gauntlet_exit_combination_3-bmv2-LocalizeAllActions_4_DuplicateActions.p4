...
control ingress(inout Headers h, inout Meta m, inout standard_metadata_t sm) {
    ...
    @name("do_action") action do_action_0(@name("val") inout bit<48> val_0) {
        val_0 = 48w2;
        exit;
    }
    @name("do_action") action do_action(@name("val") inout bit<48> val_0) {
        val_0 = 48w2;
        exit;
    }
    @name("do_action") action do_action_1(@name("val") inout bit<48> val_0) {
        val_0 = 48w2;
        exit;
    }
    ...
    apply {
        ...
        if (!hasReturned) {
            do_action_1(h.eth_hdr.dst_addr);
        }
    }
}

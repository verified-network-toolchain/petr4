...
control ingress(inout Headers h, inout Meta m, inout standard_metadata_t sm) {
    @name("simple_action") action simple_action_0(@name("val") in ethernet_t val_0) {
        h.eth_hdr.src_addr = val_0.src_addr;
    }
    @name("simple_action") action simple_action(@name("val") in ethernet_t val_0) {
        h.eth_hdr.src_addr = val_0.src_addr;
    }
    apply {

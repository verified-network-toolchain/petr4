...
control ingress(inout Headers h, inout Meta m, inout standard_metadata_t sm) {
    ...
    @name("tmp_val") bit<8> tmp_val_0;
    bit<4> tmp;
    @name("simple_action") action simple_action_0(@name("dummy") inout bit<4> dummy_0) {
    }
    @name("simple_action") action simple_action(@name("dummy") inout bit<4> dummy_0) {
    }

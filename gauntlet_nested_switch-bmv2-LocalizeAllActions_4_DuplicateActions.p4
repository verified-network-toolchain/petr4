...
control ingress(inout Headers h, inout Meta m, inout standard_metadata_t sm) {
    ...
    @name("simple_val") bit<16> simple_val_0;
    @name("call_action") action call_action_0(@name("val") inout bit<48> val_0) {
    }
    @name("call_action") action call_action(@name("val") inout bit<48> val_0) {
    }

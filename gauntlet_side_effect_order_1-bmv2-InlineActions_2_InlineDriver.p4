...
control ingress(inout Headers h, inout Meta m, inout standard_metadata_t sm) {
    bit<16> tmp;
    bit<16> tmp_0;
    @name("do_action_1") action do_action(@name("val_1") out bit<16> val_0, @name("val_2") out bit<16> val_3) {
        val_0 = val_3;
    }
    @name("do_action_2") action do_action_0(@name("val") out bit<16> val_4) {
        {
            @name("val_1") bit<16> val;
            @name("val_2") bit<16> val_1;
            val = val_1;
            tmp = val;
            tmp_0 = val_1;
        }

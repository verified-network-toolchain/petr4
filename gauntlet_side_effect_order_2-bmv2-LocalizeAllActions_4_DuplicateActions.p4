...
control ingress(inout Headers h, inout Meta m, inout standard_metadata_t sm) {
    ...
    bit<8> tmp_1;
    @name("do_thing") action do_thing_0(@name("tmp") out bit<8> tmp_2, @name("val_1") in bit<8> val) {
        h.h.a = val;
    }
    @name("do_thing") action do_thing(@name("tmp") out bit<8> tmp_2, @name("val_1") in bit<8> val) {
        h.h.a = val;
    }
    apply {
        tmp_0 = 8w3;

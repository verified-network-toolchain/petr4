...
control ingress(inout Headers h, inout Meta m, inout standard_metadata_t sm) {
    ...
    @name("tmp") bool_struct tmp_0;
    @name("dummy_action") action dummy_action_0(@name("dummy_bit") out bit<16> dummy_bit_0, @name("dummy_struct") out bool_struct dummy_struct_0) {
    }
    @name("dummy_action") action dummy_action(@name("dummy_bit") out bit<16> dummy_bit_0, @name("dummy_struct") out bool_struct dummy_struct_0) {
    }

...
@name(".do_action") action do_action(@name("val") inout ethernet_t val_0) {
    val_0.eth_type = 16w0xdead;
}
...
control ingress(inout Headers h, inout Meta m, inout standard_metadata_t sm) {
    @name(".do_action") action do_action_0(@name("val") inout ethernet_t val_0) {
        val_0.eth_type = 16w0xdead;
    }
    @name(".do_action") action do_action_1(@name("val") inout ethernet_t val_0) {
        val_0.eth_type = 16w0xdead;
    }
    apply {
        exit;
        do_action_1(h.eth_hdr);
    }
}

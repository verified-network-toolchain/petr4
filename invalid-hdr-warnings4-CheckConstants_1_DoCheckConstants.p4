...
control IngressI(inout H hdr, inout M meta, inout standard_metadata_t smeta) {
    ...
    @name("hd") Header hd_6;
    @name("hd") Header hd;
    @name("validateHeader") action validateHeader_0() {
        hd = h.h1[0];
        hd.setValid();
        h.h1[0] = hd;
    }
    @name("hd") Header hd_2;
    @name("validateHeader") action validateHeader_2() {
        hd_2 = h.h2[tmp_0];
        hd_2.setValid();
        h.h2[tmp_0] = hd_2;
    }
    @name("hd") Header hd_7;
    @name("invalidateHeader") action invalidateHeader_0() {
        hd_7 = h.h2[0];
        hd_7.setInvalid();
        h.h2[0] = hd_7;
    }
    @name("stack") Header[2] stack;
    @name("invalidateStack") action invalidateStack_0() {
        stack = h.h1;
        {
            hd_3 = stack[0];
            hd_3.setInvalid();
    ...
    @name("stack") Header[2] stack_1;
    @name("invalidateStack") action invalidateStack_2() {
        stack_1 = h_copy.h1;
        {
            hd_5 = stack_1[0];
            hd_5.setInvalid();

...
control IngressI(inout H hdr, inout M meta, inout standard_metadata_t smeta) {
    ...
    @name("validateHeader") action validateHeader_0(inout Header hd) {
        hd.setValid();
    }
    @name("invalidateHeader") action invalidateHeader_0(inout Header hd) {
        hd.setInvalid();
    }
    @name("invalidateStack") action invalidateStack_0(inout Header[2] stack) {
        invalidateHeader_0(stack[0]);
        invalidateHeader_0(stack[1]);
    }
    apply {
        h_0.h1[0].setInvalid();
        h_0.h1[1].setInvalid();
        ...
        h_copy_0.h2[0].data = 32w1;
        h_copy_0.h2[1].data = 32w1;
        invalidateHeader_0(h_0.h2[0]);
        h_copy2_0 = (H){h1 = h_0.h1,h2 = h_0.h2};
        h_copy2_0.h1[0].data = 32w1;
        h_copy2_0.h1[1].data = 32w1;
        h_copy2_0.h2[0].data = 32w1;
        h_copy2_0.h2[1].data = 32w1;
        @name("i") bit<1> i_0 = 1w1;
        h_copy2_0.h2[i_0] = h_0.h2[0];
        h_copy2_0.h1[0].data = 32w1;
        h_copy2_0.h1[1].data = 32w1;
        h_copy2_0.h2[0].data = 32w1;
        h_copy2_0.h2[1].data = 32w1;
        validateHeader_0(h_0.h2[i_0]);
        h_copy2_0.h2[i_0] = h_0.h2[0];
        h_copy2_0.h1[0].data = 32w1;
        h_copy2_0.h1[1].data = 32w1;
        h_copy2_0.h2[0].data = 32w1;
        h_copy2_0.h2[1].data = 32w1;
        invalidateStack_0(h_0.h1);
        invalidateStack_0(h_copy_0.h1);
        h_copy_0.h1[0] = h_0.h1[i_0];
        h_copy_0.h1[0].data = 32w1;
        h_copy_0.h1[1].data = 32w1;
        h_0.h1[1].setValid();
        h_copy_0.h1[0] = h_0.h1[i_0];

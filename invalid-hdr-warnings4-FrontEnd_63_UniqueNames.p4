...
control IngressI(inout H hdr, inout M meta, inout standard_metadata_t smeta) {
    ...
    @name("hd") Header hd_8;
    @name("hd") Header hd_9;
    @name("hd") Header hd_10;
    @name("validateHeader") action validateHeader() {
        hd_10 = h_0.h1[0];
        hd_10.setValid();
        h_0.h1[0] = hd_10;
    }
    @name("hd") Header hd_11;
    @name("validateHeader") action validateHeader_1() {
        hd_11 = h_0.h2[tmp];
        hd_11.setValid();
        h_0.h2[tmp] = hd_11;
    }
    @name("hd") Header hd_12;
    @name("invalidateHeader") action invalidateHeader() {
        hd_12 = h_0.h2[0];
        hd_12.setInvalid();
        h_0.h2[0] = hd_12;
    }
    @name("stack") Header[2] stack_0;
    @name("invalidateStack") action invalidateStack() {
        stack_0 = h_0.h1;
        hd_0 = stack_0[0];
        hd_0.setInvalid();
        stack_0[0] = hd_0;
    ...
    @name("stack") Header[2] stack_2;
    @name("invalidateStack") action invalidateStack_1() {
        stack_2 = h_copy_0.h1;
        hd_8 = stack_2[0];
        hd_8.setInvalid();
        stack_2[0] = hd_8;

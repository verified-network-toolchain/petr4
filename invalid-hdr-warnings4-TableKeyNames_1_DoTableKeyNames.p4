...
parser ParserI(packet_in pkt, out H hdr, inout M meta, inout standard_metadata_t smeta) {
    state start {
        ...
        hdr.h1[0].data = (bit<32>)32w1;
        hdr.h1[1].data = (bit<32>)32w1;
        transition init;
    }
    state init {
...
control IngressI(inout H hdr, inout M meta, inout standard_metadata_t smeta) {
    ...
    apply {
        ...
        h.h1[0].data = (bit<32>)32w1;
        h.h1[1] = h.h1[0];
        h.h1[1].data = (bit<32>)32w1;
        h.h2 = h.h1;
        h.h2[0].data = (bit<32>)32w1;
        h.h2[1].data = (bit<32>)32w1;
        h_copy = h;
        h_copy.h1[0].data = (bit<32>)32w1;
        h_copy.h1[1].data = (bit<32>)32w1;
        h_copy.h2[0].data = (bit<32>)32w1;
        h_copy.h2[1].data = (bit<32>)32w1;
        invalidateHeader(h.h2[0]);
        h_copy2 = (H){h1 = h.h1,h2 = h.h2};
        h_copy2.h1[0].data = (bit<32>)32w1;
        h_copy2.h1[1].data = (bit<32>)32w1;
        h_copy2.h2[0].data = (bit<32>)32w1;
        h_copy2.h2[1].data = (bit<32>)32w1;
        bit<1> i = (bit<1>)1w1;
        h_copy2.h2[i] = h.h2[0];
        h_copy2.h1[0].data = (bit<32>)32w1;
        h_copy2.h1[1].data = (bit<32>)32w1;

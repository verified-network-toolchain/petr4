...
parser ParserI(packet_in pkt, out H hdr, inout M meta, inout standard_metadata_t smeta) {
    state start {
        ...
        hdr.u1.h1.data = (bit<32>)32w1;
        hdr.u1.h3.data = (bit<32>)32w1;
        hdr.u1.h1 = hdr.u1.h3;
        hdr.u1.h1.data = (bit<32>)32w1;
        hdr.u1.h3.data = (bit<32>)32w1;
...
control IngressI(inout H hdr, inout M meta, inout standard_metadata_t smeta) {
    ...
    apply {
        ...
        u2.h1 = u1.h1;
        u2.h1.data = (bit<32>)32w1;
        u1.h2.setValid();
        u2 = u1;
        u2.h1.data = (bit<32>)32w1;
        u2.h2.data = (bit<16>)16w1;
        if (u2.h2.data == 16w0) {
            u1.h1.setValid();
        } else {
            u1.h2.setValid();
        }
        u1.h1.data = (bit<32>)32w1;
        u1.h2.data = (bit<16>)16w1;
        u1.h3.setInvalid();
        u1.h1.data = (bit<32>)32w1;
        u1.h2.data = (bit<16>)16w1;
        u1.h3.data = (bit<32>)32w1;
    }
}

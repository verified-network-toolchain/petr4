...
control c(inout bit<32> x) {
    ...
    @name("us") U[2] us_0;
    @name("i") bit<1> i_0;
    @name("initialize") action initialize(@name("u1") out U u1_0, @name("hs1") out H1[2] hs1_0, @name("us1") out U[2] us1_0) {
        u1_0.h1.a = 32w1;
        u1_0.h2.a = 32w1;
        hs1_0[0].a = 32w1;
        hs1_0[1].a = 32w1;
    ...
    @name("inout_action1") action inout_action1(@name("u1") inout U u1_1, @name("hs1") inout H1[2] hs1_1, @name("us1") inout U[2] us1_1) {
        u1_1.h1.a = 32w1;
        u1_1.h2.a = 32w1;
        hs1_1[0].a = 32w1;
        hs1_1[1].a = 32w1;

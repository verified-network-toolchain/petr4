...
control MyIngress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name("set_dmac") action set_dmac_0(@name("dstAddr") macAddr_t dstAddr_2) {
    ...
    @name("set_nhop") action set_nhop_0(@name("dstAddr") ip4Addr_t dstAddr_3, @name("port") egressSpec_t port) {
...
control MyEgress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name("rewrite_mac") action rewrite_mac_0(@name("srcAddr") macAddr_t srcAddr_1) {

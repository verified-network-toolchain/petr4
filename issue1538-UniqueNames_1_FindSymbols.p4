...
parser ParserImpl(packet_in packet, out headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name("tmp_port") bit<16> tmp_port_1;
    state start {
        {
    ...
    state start_0 {
        packet.extract<ethernet_t>(hdr.ethernet);
        {
            ...
            hasReturned_1 = true;
            retval_1 = x_2 + 16w1;
            hdr.ethernet.etherType = retval_1;
        }
...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name("set_port") action set_port_0(@name("output_port") bit<9> output_port) {
    ...
    apply {
        mac_da.apply();
        {
            ...
            @name("retval_0") bit<16> retval_2;
            @name("tmp") bit<16> tmp_2;
            @name("tmp_0") bit<16> tmp_3;
            @name("tmp_1") bit<16> tmp_4;
            hasReturned_2 = false;
            tmp_2 = x_3;
            {
                bit<16> x_0 = x_3;
            ...
            hasReturned_2 = true;
            retval_2 = tmp_4;
            hdr.ethernet.srcAddr[15:0] = retval_2;
        }
        {
            ...
            hasReturned_1 = true;
            retval_1 = x_4 + 16w1;
            hdr.ethernet.srcAddr[15:0] = retval_1;
        }
        {

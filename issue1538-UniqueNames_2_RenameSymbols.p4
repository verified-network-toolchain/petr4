...
parser ParserImpl(packet_in packet, out headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name("tmp_port") bit<16> tmp_port_0;
    state start {
        {
            @name("x_1") bit<16> x = (bit<16>)standard_metadata.ingress_port;
    ...
    state start_0 {
        ...
        {
            @name("x_2") bit<16> x_6 = hdr.ethernet.etherType;
...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name("set_port") action set_port(@name("output_port") bit<9> output_port) {
    ...
    apply {
        mac_da_0.apply();
        {
            @name("x_3") bit<16> x_7 = hdr.ethernet.srcAddr[15:0];
            @name("hasReturned_0") bool hasReturned_3;
            @name("retval_0") bit<16> retval_3;
            @name("tmp") bit<16> tmp;
            @name("tmp_0") bit<16> tmp_0;
            @name("tmp_1") bit<16> tmp_1;
            hasReturned_3 = false;
            tmp = x_7;
            {
                @name("x_0") bit<16> x_8 = x_7;
                @name("hasReturned") bool hasReturned_4;
                @name("retval") bit<16> retval_4;
                hasReturned_4 = false;
                hasReturned_4 = true;
                retval_4 = x_8 + 16w1;
                tmp_0 = retval_4;
        ...
        {
            @name("x_4") bit<16> x_9 = hdr.ethernet.srcAddr[15:0];
            @name("hasReturned") bool hasReturned_5;
            @name("retval") bit<16> retval_5;
            hasReturned_5 = false;
            hasReturned_5 = true;
            retval_5 = x_9 + 16w1;
        ...
        {
            @name("x_5") bit<16> x_10 = hdr.ethernet.etherType;
            @name("hasReturned") bool hasReturned_6;
            @name("retval") bit<16> retval_6;
            hasReturned_6 = false;
            hasReturned_6 = true;
            retval_6 = x_10 + 16w1;

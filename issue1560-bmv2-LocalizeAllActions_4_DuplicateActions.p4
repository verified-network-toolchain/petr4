...
control cIngress(inout headers hdr, inout metadata meta, inout standard_metadata_t stdmeta) {
    ...
    @name("foo1") action foo1(@name("dstAddr") IPv4Address dstAddr_0) {
        hdr.ipv4.dstAddr = dstAddr_0;
    }
    @name("foo1") action foo1_1(@name("dstAddr") IPv4Address dstAddr_0) {
        hdr.ipv4.dstAddr = dstAddr_0;
    }
    @name("foo1") action foo1_2(@name("dstAddr") IPv4Address dstAddr_0) {
        hdr.ipv4.dstAddr = dstAddr_0;
    }
    @name("foo2") action foo2_0(@name("srcAddr") IPv4Address srcAddr_0) {
        hdr.ipv4.srcAddr = srcAddr_0;
    }
    @name("foo2") action foo2(@name("srcAddr") IPv4Address srcAddr_0) {
        hdr.ipv4.srcAddr = srcAddr_0;
    }
    @name("foo2") action foo2_1(@name("srcAddr") IPv4Address srcAddr_0) {
        hdr.ipv4.srcAddr = srcAddr_0;
    }
    @name("foo2") action foo2_2(@name("srcAddr") IPv4Address srcAddr_0) {
        hdr.ipv4.srcAddr = srcAddr_0;
    }
    @name("t0") table t0_0 {
        key = {

...
parser parserI(packet_in pkt, out headers hdr, inout metadata meta, inout standard_metadata_t stdmeta) {
    @name("tmp") IPv4_up_to_ihl_only_h tmp_4;
    @name("tmp_0") bit<9> tmp_5;
    @name("tmp_1") bit<9> tmp_6;
    @name("tmp_2") bit<9> tmp_7;
    @name("tmp_3") bit<32> tmp_8;
    state start {
...
control cIngress(inout headers hdr, inout metadata meta, inout standard_metadata_t stdmeta) {
    ...
    @name("foo1") action foo1_0(@name("dstAddr") IPv4Address dstAddr_1) {
        hdr.ipv4.dstAddr = dstAddr_1;
    }
    @name("foo1") action foo1_3(@name("dstAddr") IPv4Address dstAddr_2) {
        hdr.ipv4.dstAddr = dstAddr_2;
    }
    @name("foo1") action foo1_4(@name("dstAddr") IPv4Address dstAddr_3) {
        hdr.ipv4.dstAddr = dstAddr_3;
    }
    @name("foo2") action foo2_0(@name("srcAddr") IPv4Address srcAddr_1) {
        hdr.ipv4.srcAddr = srcAddr_1;
    }
    @name("foo2") action foo2_3(@name("srcAddr") IPv4Address srcAddr_2) {
        hdr.ipv4.srcAddr = srcAddr_2;
    }
    @name("foo2") action foo2_4(@name("srcAddr") IPv4Address srcAddr_3) {

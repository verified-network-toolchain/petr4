...
parser parserI(packet_in pkt, out headers hdr, inout metadata meta, inout standard_metadata_t stdmeta) {
    @name("tmp") IPv4_up_to_ihl_only_h tmp;
    @name("tmp_0") bit<9> tmp_0;
    @name("tmp_1") bit<9> tmp_1;
    @name("tmp_2") bit<9> tmp_2;
    @name("tmp_3") bit<32> tmp_3;
    state start {
...
control cIngress(inout headers hdr, inout metadata meta, inout standard_metadata_t stdmeta) {
    ...
    @name("foo1") action foo1(@name("dstAddr") IPv4Address dstAddr_1) {
        hdr.ipv4.dstAddr = dstAddr_1;
    }
    @name("foo1") action foo1_1(@name("dstAddr") IPv4Address dstAddr_2) {
        hdr.ipv4.dstAddr = dstAddr_2;
    }
    @name("foo1") action foo1_2(@name("dstAddr") IPv4Address dstAddr_3) {
        hdr.ipv4.dstAddr = dstAddr_3;
    }
    @name("foo2") action foo2(@name("srcAddr") IPv4Address srcAddr_1) {
        hdr.ipv4.srcAddr = srcAddr_1;
    }
    @name("foo2") action foo2_1(@name("srcAddr") IPv4Address srcAddr_2) {
        hdr.ipv4.srcAddr = srcAddr_2;
    }
    @name("foo2") action foo2_2(@name("srcAddr") IPv4Address srcAddr_3) {

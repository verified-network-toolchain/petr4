...
control cIngress(inout headers hdr, inout metadata meta, inout standard_metadata_t stdmeta) {
    ...
    @name("foo1") action foo1_0(@name("dstAddr") IPv4Address dstAddr_0) {
        hdr.ipv4.dstAddr = dstAddr_0;
    }
    @name("foo1") action foo1_3(@name("dstAddr") IPv4Address dstAddr_0) {
        hdr.ipv4.dstAddr = dstAddr_0;
    }
    @name("foo1") action foo1_4(@name("dstAddr") IPv4Address dstAddr_0) {
        hdr.ipv4.dstAddr = dstAddr_0;
    }
    @name("foo2") action foo2_0(@name("srcAddr") IPv4Address srcAddr_0) {
        hdr.ipv4.srcAddr = srcAddr_0;
    }
    @name("foo2") action foo2_3(@name("srcAddr") IPv4Address srcAddr_0) {
        hdr.ipv4.srcAddr = srcAddr_0;
    }
    @name("foo2") action foo2_4(@name("srcAddr") IPv4Address srcAddr_0) {
        hdr.ipv4.srcAddr = srcAddr_0;
    }
    @name("t0") table t0 {
        key = {

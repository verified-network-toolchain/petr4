...
control MyIngress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name("ipv4_forward") action ipv4_forward_0(@name("dstAddr") macAddr_t dstAddr_0, @name("port") egressSpec_t port_0) {
    ...
    @name("ipv4_forward") action ipv4_forward(@name("dstAddr") macAddr_t dstAddr_0, @name("port") egressSpec_t port_0) {
        hdr.ethernet.srcAddr = hdr.ethernet.dstAddr;
        hdr.ethernet.dstAddr = dstAddr_0;
        standard_metadata.egress_spec = port_0;
        hdr.ipv4.ttl = hdr.ipv4.ttl + 8w255;

...
control MyIngress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name("mac_tmp") mac_addr_t mac_tmp_0;
    @name("addr_tmp") ipv6_addr_t addr_tmp_0;
    @name("set_egress_port") action set_egress_port_0(@name("out_port") port_t out_port_0) {
        standard_metadata.egress_spec = out_port_0;
    }
    @name("set_egress_port") action set_egress_port(@name("out_port") port_t out_port_0) {
        standard_metadata.egress_spec = out_port_0;
    }
    @name("set_egress_port") action set_egress_port_1(@name("out_port") port_t out_port_0) {
        standard_metadata.egress_spec = out_port_0;
    }
    ...
    @name("controller_reply") action controller_reply_0(@name("task") task_t task_0) {
        meta.task = task_0;
        meta.ingress_port = standard_metadata.ingress_port;
        clone_preserving_field_list(CloneType.I2E, 32w100, 8w0);
    }
    @name("controller_reply") action controller_reply(@name("task") task_t task_0) {
        meta.task = task_0;
        meta.ingress_port = standard_metadata.ingress_port;
        clone_preserving_field_list(CloneType.I2E, 32w100, 8w0);
    }
    @name("controller_reply") action controller_reply_1(@name("task") task_t task_0) {
        meta.task = task_0;
        meta.ingress_port = standard_metadata.ingress_port;
        clone_preserving_field_list(CloneType.I2E, 32w100, 8w0);
    }

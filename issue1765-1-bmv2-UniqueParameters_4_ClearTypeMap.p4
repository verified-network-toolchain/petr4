...
control MyIngress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name("set_egress_port") action set_egress_port_0(@name("out_port") port_t out_port) {
        standard_metadata.egress_spec = out_port;
    }
    @name("set_egress_port") action set_egress_port_2(@name("out_port") port_t out_port_1) {
    ...
    @name("controller_reply") action controller_reply_0(@name("task") task_t task_1) {
        meta.task = task_1;
        meta.ingress_port = standard_metadata.ingress_port;
        clone_preserving_field_list(CloneType.I2E, 32w100, 8w0);
    }
    @name("controller_reply") action controller_reply_2(@name("task") task_t task_2) {
        meta.task = task_2;
        meta.ingress_port = standard_metadata.ingress_port;
        clone_preserving_field_list(CloneType.I2E, 32w100, 8w0);
    }

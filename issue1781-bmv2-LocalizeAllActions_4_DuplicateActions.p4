...
control IngressImpl(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name("value") bit<32> value_0;
    @name("update_value") action update_value_0(@name("value") out bit<32> value_1) {
        value_1 = test_func();
    }
    @name("update_value") action update_value(@name("value") out bit<32> value_1) {
        value_1 = test_func();
    }
    apply {

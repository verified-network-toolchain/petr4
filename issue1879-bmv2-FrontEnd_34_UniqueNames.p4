...
parser SubParser(packet_in packet, out prot_i_t inf, inout metadata meta, in bool currentISelected, in bit<8> currI) {
    state start {
        ...
        @name("currentISelected2") bool currentISelected2_0 = currI == meta.currPos;
...
parser PROTParser(packet_in packet, out headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    state parse_prot_host_addr_src_ipv4 {
        ...
        @name("paddingLen") bit<9> paddingLen_0 = 9w64 - (meta.addrLen & 9w63) & 9w63;
        ...
        @name("currentISelected") bool currentISelected_0 = hdr.prot_common.curri == meta.currPos;
    ...
    state parse_prot_1 {
        @name("hdrLeft") bit<8> hdrLeft_0 = meta.headerLen - meta.currPos;
    ...
    state parse_prot_inf_1 {
        @name("currentISelected") bool currentISelected_1 = meta.currPos == hdr.prot_common.curri;

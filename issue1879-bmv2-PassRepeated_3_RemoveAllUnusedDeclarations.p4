...
parser PROTParser(packet_in packet, out headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name("paddingLen") bit<9> paddingLen;
    @name("currentISelected") bool currentISelected;
    @name("hdrLeft") bit<8> hdrLeft;
    @name("currentISelected") bool currentISelected_3;
    @name("inf_0") prot_i_t inf;
    @name("meta_0") metadata meta_1;
    @name("currentISelected_2") bool currentISelected_4;
    @name("currI_0") bit<8> currI;
    @name("subParser.currentISelected2") bool subParser_currentISelected2_0;
    state start {

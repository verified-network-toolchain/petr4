...
@name(".foo") action foo(@name("x") out bit<8> x_0, @name("y") in bit<8> y_0=5) {
    x_0 = y_0 >> 2;
}
control ingressImpl(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t stdmeta) {
    @name(".foo") action foo_0(@name("x") out bit<8> x_0, @name("y") in bit<8> y_0=5) {
        x_0 = y_0 >> 2;
    }
    @name(".foo") action foo_1(@name("x") out bit<8> x_0, @name("y") in bit<8> y_0=5) {
        x_0 = y_0 >> 2;
    }
    @name(".foo") action foo_2(@name("x") out bit<8> x_0, @name("y") in bit<8> y_0=5) {
        x_0 = y_0 >> 2;
    }
    bit<8> tmp;
    apply {

...
control ingressImpl(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t stdmeta) {
    @name("foo2_inst.idx") bit<32> foo2_inst_idx_0;
    @name("foo2_inst.val") bit<8> foo2_inst_val_0;
    @noWarn("unused") @name(".NoAction") action NoAction_0() {
    }
    @name("reg1") register<bit<8>>(32w256) reg1;
    @name("foo2_inst.foo2_action") action foo2_inst_foo2_action() {
        foo2_inst_idx_0 = (bit<32>)hdr.ethernet.srcAddr[7:0];
        reg1.read(foo2_inst_val_0, foo2_inst_idx_0);
        foo2_inst_val_0 = foo2_inst_val_0 + 8w249;
        reg1.write(foo2_inst_idx_0, foo2_inst_val_0);
    }
    @name("foo2_inst.foo2_table") table foo2_inst_foo2_table_0 {
        key = {

...
bit<16> do_thing_function() {
    ...
    @name("not_initialized") H not_initialized;
    @name("new_val") bit<32> new_val;
    not_initialized.setInvalid();
    new_val = 32w1;
    ...
    {
        hasReturned_0 = true;
        retval_0 = (bit<16>)new_val;
    }
    return retval_0;
}
control ingress(inout Headers h, inout Meta m, inout standard_metadata_t sm) {
    @name("do_thing_action") action do_thing_action_0() {
    }
    apply {

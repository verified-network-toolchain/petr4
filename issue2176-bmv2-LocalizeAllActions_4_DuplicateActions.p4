...
control ingress(inout Parsed_packet h, inout Metadata m, inout standard_metadata_t sm) {
    ...
    bit<8> tmp_0;
    bit<8> tmp_1;
    @name("do_action_2") action do_action(@name("val_0") inout bit<8> val, @name("val_1") inout bit<8> val_3, @name("val_2") inout bit<8> val_4) {
        val_3 = 8w2;
        val_4 = 8w0;
    }
    @name("do_action_2") action do_action_0(@name("val_0") inout bit<8> val, @name("val_1") inout bit<8> val_3, @name("val_2") inout bit<8> val_4) {
        val_3 = 8w2;
        val_4 = 8w0;
    }
    apply {

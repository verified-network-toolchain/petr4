...
control ingress(inout Parsed_packet h, inout Metadata m, inout standard_metadata_t sm) {
    @name("tmp") bit<8> tmp_2;
    @name("tmp_0") bit<8> tmp_3;
    @name("tmp_1") bit<8> tmp_4;
    @name("do_action_2") action do_action(@name("val_0") inout bit<8> val_0, @name("val_1") inout bit<8> val_1, @name("val_2") inout bit<8> val_2) {
        val_1 = 8w2;
        val_2 = 8w0;
    }
    apply {

...
control ingressImpl(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t stdmeta) {
    @name("bool1") bool bool1_0;
    @name("bit1") bit<1> bit1_0;
    @name("enum1") MyEnum_t enum1_0;
    @name("serenum1") MySerializableEnum_t serenum1_0;
    @name("signed1") int<8> signed1_0;
    @name("unsigned1") bit<8> unsigned1_0;
    apply {

...
control ingress(inout Headers h, inout Meta m, inout standard_metadata_t sm) {
    @name("tmp_0") bit<16> tmp;
    @name("tmp_3") bit<16> tmp_1;
    @name("tmp_6") bit<16> tmp_2;
    apply {
        tmp = function_with_side_effect(h.eth_hdr.eth_type);
        tmp_1 = function_with_side_effect(h.eth_hdr.eth_type);
        tmp_2 = function_with_side_effect(h.eth_hdr.eth_type);
    }
}

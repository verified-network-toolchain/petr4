...
control ingress(inout Headers h, inout Meta m, inout standard_metadata_t sm) {
    @name("dummy_var") bit<16> dummy_var_0;
    bit<16> tmp;
    bit<16> tmp_0;
    bit<16> tmp_1;
    bit<16> tmp_2;
    ...
    apply {
        tmp = 16w0;
        tmp_0 = function_with_side_effect(h.eth_hdr.eth_type);
        tmp_1 = tmp & tmp_0;
        dummy_var_0 = tmp_1;
        tmp_2 = 16w0;
        tmp_3 = function_with_side_effect(h.eth_hdr.eth_type);
        tmp_4 = tmp_2 * tmp_3;
        dummy_var_0 = tmp_4;
        tmp_5 = 16w0;
        tmp_6 = function_with_side_effect(h.eth_hdr.eth_type);
        tmp_7 = tmp_5 >> tmp_6;
        dummy_var_0 = tmp_7;
    }
}

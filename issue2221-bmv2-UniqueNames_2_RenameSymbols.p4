...
control ingress(inout Headers h, inout Meta m, inout standard_metadata_t sm) {
    ...
    @name("tmp_6") bit<16> tmp_4;
    apply {
        {
            @name("eth_type_0") bit<16> eth_type_3 = h.eth_hdr.eth_type;
        ...
        {
            @name("eth_type_1") bit<16> eth_type_4 = h.eth_hdr.eth_type;
        ...
        {
            @name("eth_type_2") bit<16> eth_type_5 = h.eth_hdr.eth_type;
            @name("hasReturned") bool hasReturned_2;
            @name("retval") bit<16> retval_2;
            hasReturned_2 = false;
            eth_type_5 = 16w0x806;
            hasReturned_2 = true;
            retval_2 = 16w2;

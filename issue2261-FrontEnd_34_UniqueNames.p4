...
bit<16> simple_function() {
    @name("tmp_struct") nested_struct tmp_struct_0 = (nested_struct){eth_hdr = (ethernet_t){dst_addr = 48w0,src_addr = 48w0,eth_type = 16w0}};
    return tmp_struct_0.eth_hdr.eth_type;
}

    ...
    apply {
        {
            ...
            @name("tmp_struct") nested_struct tmp_struct;
            hasReturned_0 = false;
            tmp_struct.eth_hdr.setValid();
            tmp_struct = (nested_struct){eth_hdr = (ethernet_t){dst_addr = 48w0,src_addr = 48w0,eth_type = 16w0}};
            hasReturned_0 = true;
            retval_0 = tmp_struct.eth_hdr.eth_type;
            h.eth_hdr.eth_type = retval_0;
        }
    }
}

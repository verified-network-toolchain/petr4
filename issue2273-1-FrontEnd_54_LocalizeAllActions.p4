...
control ingress(inout headers hdr) {
    ...
    @name("write") StackAction<bit<16>, bit<16>>(stack_0) write_0 = {
    ...
    @name("push") action push_1() {
        hdr.data.b1 = 8w0xff;
        write_0.push();
    }
    @name("do_push") table do_push_0 {
        actions = {
            push_1();
    ...
    @name("pop") action pop_1() {
        hdr.data.b1 = 8w0xfe;
        hdr.data.h1 = read_0.pop();
    }
    @name("do_pop") table do_pop_0 {
        actions = {
            pop_1();

...
control ingress(inout Headers h, inout Meta m, inout standard_metadata_t sm) {
    ...
    apply {
        tmp = function_with_side_effect(h.h.a);
        tmp_1 = function_with_side_effect(h.h.b);
        tmp_2 = function_with_side_effect(h.h.c);
        tmp_4 = function_with_side_effect(h.h.d);
        tmp_5 = function_with_side_effect(h.h.e);
        tmp_7 = function_with_side_effect(h.h.f);
        dummy_var = function_with_side_effect(h.h.g);
        tmp_8 = function_with_side_effect(h.h.h);
        tmp_10 = function_with_side_effect(h.h.i);
        tmp_11 = function_with_side_effect(h.h.j);
        tmp_13 = function_with_side_effect(h.h.k);
        tmp_14 = function_with_side_effect(h.h.l);
        tmp_16 = function_with_side_effect(h.h.m);
        tmp_17 = function_with_side_effect(h.b.c);
        tmp_19 = function_with_side_effect(h.b.c);
        tmp_20 = function_with_side_effect(h.b.d);
        tmp_22 = function_with_side_effect(h.b.d);
    }
}

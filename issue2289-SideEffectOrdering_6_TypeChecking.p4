...
bit<16> function_1() {
    @name("tmp_struct") nested_struct tmp_struct_0;
    tmp_struct_0 = (nested_struct){s = (simple_struct){a = 32w1}};
    tmp_struct_0.s.a = 32w1;
    return 16w1;
}
...
control ingress(inout Headers h, inout Meta m, inout standard_metadata_t sm) {
    @name("simple_action") action simple_action_0(out bit<16> byaA) {
        bit<16> tmp_0;
        {
            tmp_0 = function_1();
            h.eth_hdr.eth_type = function_2(tmp_0);
        }
    }
    apply {
        function_1();

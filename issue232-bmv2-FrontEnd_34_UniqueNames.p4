...
control Eg(inout Headers hdrs, inout Metadata meta, inout standard_metadata_t standard_meta) {
    ...
    @name("test") action test_0() {
        @name("inKey") Key inKey_0 = (Key){field1 = 32w1};
        @name("defaultKey") Key defaultKey_0 = (Key){field1 = 32w0};
        @name("same") bool same_0 = inKey_0 == defaultKey_0;
        @name("val") Value val_0 = (Value){field1 = 32w0};
        @name("done") bool done_0 = false;
        @name("ok") bool ok_0 = !done_0 && same_0;
        if (ok_0) {
            update_0(val_0);
        }
    }

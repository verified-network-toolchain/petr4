...
control Eg(inout Headers hdrs, inout Metadata meta, inout standard_metadata_t standard_meta) {
    @name("inKey") Key inKey_0;
    @name("defaultKey") Key defaultKey_0;
    @name("same") bool same_0;
    @name("val") Value val_0;
    @name("done") bool done_0;
    @name("ok") bool ok_0;
    @name("update") action update_0(@name("val") inout Value val_1) {
        val_1.field1 = 32w8;
    }

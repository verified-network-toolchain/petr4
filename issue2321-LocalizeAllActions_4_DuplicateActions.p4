...
control ingressImpl(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t stdmeta) {
    ...
    @name("a1") action a1_0(@name("x") inout bit<48> x_0) {
        hdr.ethernet.srcAddr = 48w5;
        x_0 = x_0 + 48w281474976710649;
    }
    @name("a1") action a1(@name("x") inout bit<48> x_0) {
        hdr.ethernet.srcAddr = 48w5;
        x_0 = x_0 + 48w281474976710649;
    }
    @name("a2") action a2_0(@name("y") in bit<16> y_0, @name("z") in bit<16> z_0) {
        hdr.ethernet.srcAddr[15:0] = y_0 + z_0;
    }
    @name("a2") action a2(@name("y") in bit<16> y_0, @name("z") in bit<16> z_0) {
        hdr.ethernet.srcAddr[15:0] = y_0 + z_0;
    }
    @name("t1") table t1_0 {
        key = {

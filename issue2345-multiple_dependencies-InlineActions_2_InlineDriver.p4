...
action dummy1(@name("dst") inout bit<48> dst_0, @name("type") inout bit<16> type_0) {
    @name("c") bool c_0;
    @name("c1") bool c1_0;
    c_0 = true;
    c1_0 = false;
...
action dummy(@name("val1") inout Headers val1_0) {
    {
        @name("dst") bit<48> dst = val1_0.eth_hdr.dst_addr;
        @name("type") bit<16> type_1 = val1_0.eth_hdr.eth_type;
        @name("c") bool c_0;
        @name("c1") bool c1_0;
        c_0 = true;
        c1_0 = false;
        ...
        val1_0.eth_hdr.dst_addr = dst;
        val1_0.eth_hdr.eth_type = type_1;
    }
    ...
    @name("simple_action") action simple_action_0() {
        ...
        if (!hasReturned) {
            h.eth_hdr.src_addr = 48w1;
            {
                ...
                {
                    @name("dst") bit<48> dst = val1.eth_hdr.dst_addr;
                    @name("type") bit<16> type_1 = val1.eth_hdr.eth_type;
                    @name("c") bool c_0;
                    @name("c1") bool c1_0;
                    c_0 = true;
                    c1_0 = false;

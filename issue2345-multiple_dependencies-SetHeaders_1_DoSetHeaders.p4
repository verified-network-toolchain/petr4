...
control ingress(inout Headers h, inout Meta m, inout standard_metadata_t sm) {
    ...
    @name("dst") bit<48> dst_0;
    @name("type") bit<16> type_0;
    @name("c") bool c;
    @name("c1") bool c1;
    @name("simple_action") action simple_action_0() {
        ...
        if (!hasReturned_0) {
            h.eth_hdr.src_addr = 48w1;
            {
                val1_0 = h;
                {
                    dst_0 = val1_0.eth_hdr.dst_addr;
                    type_0 = val1_0.eth_hdr.eth_type;
                    c = true;
                    c1 = false;
                    if (c) {
                        type_0 = type_0;
                    ...
                    val1_0.eth_hdr.dst_addr = dst_0;
                    val1_0.eth_hdr.eth_type = type_0;
                }

...
control ingress(inout Headers h, inout Meta m, inout standard_metadata_t sm) {
    ...
    @name("tmp") bool tmp_0;
    @name("do_action") action do_action_0(@name("val1") inout bool val1_0, @name("val2") inout bool val2_0) {
    }
    @name("do_action") action do_action(@name("val1") inout bool val1_0, @name("val2") inout bool val2_0) {
    }
    @name("simple_table") table simple_table_0 {
        key = {
        }
        actions = {
            do_action(tmp_0, tmp_0);

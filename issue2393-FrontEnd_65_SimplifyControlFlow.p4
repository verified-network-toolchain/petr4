...
control ingress(inout Headers h) {
    ...
    @name("tmp") bool tmp_0;
    @name("make_zero") bool make_zero_0;
    @name("val_undefined") bool val_undefined_0;
    @name("tmp") bit<16> tmp_4;
    @name("make_zero") bool make_zero_2;
    @name("val_undefined") bool val_undefined_2;

...
control ingress(inout Headers h) {
    ...
    @name(".do_global_action") action do_global_action_1(@name("make_zero") in bool make_zero_0, @name("val_undefined") out bool val_undefined_0) {
        @name("tmp") bit<16> tmp_0;
        tmp_0 = tmp_0 * (make_zero_0 ? 16w0 : 16w1);
    }
    ...
    @name("simple_table") table simple_table_0 {
        ...
        actions = {
            do_action();
            do_global_action_1(true, filler_bool_0);

...
control ingress(inout Headers h) {
    @name(".do_global_action") action do_global_action(@name("make_zero") in bool make_zero, @name("val_undefined") out bool val_undefined) {
    ...
    @name("do_action") action do_action_0() {
        tmp_2 = tmp_bool;
        {
            @name("make_zero") bool make_zero_1 = tmp_2;

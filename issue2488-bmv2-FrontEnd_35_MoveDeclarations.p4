...
control ingress(inout Headers h, inout Meta m, inout standard_metadata_t sm) {
    @name("tmp") Headers tmp_0 = (Headers){eth_hdr = (ethernet_t){dst_addr = h.eth_hdr.dst_addr,src_addr = set(h.eth_hdr.dst_addr),eth_type = 16w1}};
    @name("t") tuple<bit<48>, bit<48>> t_0 = { h.eth_hdr.dst_addr, set(h.eth_hdr.dst_addr) };
    apply {
        h = tmp_0;
    }
}

...
control ingress(inout Headers h, inout Meta m, inout standard_metadata_t sm) {
    @name("tmp") Headers tmp_0;
    @name("t") tuple<bit<48>, bit<48>> t_0;
    ethernet_t tmp;
    bit<48> tmp_1;
    bit<48> tmp_2;
    bit<48> tmp_3;
    ...
    apply {
        ...
        tmp_3 = set(h.eth_hdr.dst_addr);
        tmp_2 = tmp_3;
        tmp_4 = 16w1;
        tmp = (ethernet_t){dst_addr = tmp_1,src_addr = tmp_2,eth_type = tmp_4};
        tmp_0 = (Headers){eth_hdr = tmp};
        tmp_5 = h.eth_hdr.dst_addr;
        tmp_7 = set(h.eth_hdr.dst_addr);
        tmp_6 = tmp_7;
        t_0 = { tmp_5, tmp_6 };
        h = tmp_0;
    }

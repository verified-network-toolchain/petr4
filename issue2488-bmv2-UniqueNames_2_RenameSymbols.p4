...
control ingress(inout Headers h, inout Meta m, inout standard_metadata_t sm) {
    ...
    @name("tmp") ethernet_t tmp_0;
    @name("tmp_1") bit<48> tmp_1;
    @name("tmp_2") bit<48> tmp_2;
    @name("tmp_3") bit<48> tmp_3;
    @name("tmp_4") bit<16> tmp_4;
    apply {
        tmp_1 = h.eth_hdr.dst_addr;
        {
            @name("s_0") bit<48> s = h.eth_hdr.dst_addr;
            @name("hasReturned") bool hasReturned;
            @name("retval") bit<48> retval;
            hasReturned = false;
            s = 48w1;
            hasReturned = true;
            retval = 48w2;
        ...
        {
            @name("s_1") bit<48> s_2 = h.eth_hdr.dst_addr;
            @name("hasReturned") bool hasReturned_1;
            @name("retval") bit<48> retval_1;
            hasReturned_1 = false;
            s_2 = 48w1;
            hasReturned_1 = true;
            retval_1 = 48w2;

...
control ingress(inout Headers h, inout Meta m, inout standard_metadata_t sm) {
    @name("tmp") Headers tmp_5;
    @name("tmp") ethernet_t tmp_6;
    @name("tmp_1") bit<48> tmp_7;
    @name("tmp_2") bit<48> tmp_8;
    @name("tmp_3") bit<48> tmp_9;
    @name("tmp_4") bit<16> tmp_10;
    apply {
        tmp_7 = h.eth_hdr.dst_addr;
        tmp_9 = set(h.eth_hdr.dst_addr);
        tmp_8 = tmp_9;
        tmp_10 = 16w1;
        tmp_6 = (ethernet_t){dst_addr = tmp_7,src_addr = tmp_8,eth_type = tmp_10};
        tmp_5 = (Headers){eth_hdr = tmp_6};

...
control ingress(inout Headers h, inout Meta m, inout standard_metadata_t sm) {
    bit<1> tmp;
    @name("slice_action") action slice_action_0(@name("sliced_val") inout bit<1> sliced_val_0) {
        h.h.a = 8w2;
        sliced_val_0 = 1w1;
    }
    @name("slice_action") action slice_action(@name("sliced_val") inout bit<1> sliced_val_0) {
        h.h.a = 8w2;
        sliced_val_0 = 1w1;
    }
    apply {

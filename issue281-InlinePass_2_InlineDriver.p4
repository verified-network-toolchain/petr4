...
parser L2(packet_in b, out h hdr) {
    ...
    state start {
        ...
        transition EthernetParser_start;
    }
    state EthernetParser_start {
...
parser L3(packet_in b, inout h hdr) {
    @name("etherType") bit<16> etherType_0;
    ...
    state ipv4 {
        hdr.ipv4.setInvalid();
        transition Ipv4Parser_start;
    }
    state Ipv4Parser_start {
    ...
    state vlan {
        hdr.vlan.setInvalid();
        transition VlanParser_start;
    }
    state VlanParser_start {
...
parser MyParser(packet_in b, out h hdr, inout m meta, inout standard_metadata_t std) {
    @name("l2") L2() l2_0;
    @name("l2.ep") EthernetParser() l2_ep;
    @name("l3") L3() l3_0;
    @name("l3.etherType") bit<16> l3_etherType;
    @name("l3.ip") Ipv4Parser() l3_ip;
    @name("l3.vp") VlanParser() l3_vp;
    state start {
        transition start_0;
    }
    state start_0 {

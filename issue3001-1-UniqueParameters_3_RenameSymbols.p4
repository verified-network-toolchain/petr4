...
U g() {
    @name("hasReturned_0") bool hasReturned_3 = false;
    @name("retval_0") U retval_3;
    @name("u") U u;
    u.h.setInvalid();
    {
        hasReturned_3 = true;
...
H[1] h() {
    @name("hasReturned_1") bool hasReturned_4 = false;
    @name("retval_1") H[1] retval_4;
    @name("s") H[1] s;
    s[0].setInvalid();
    {
        hasReturned_4 = true;
...
control ingressImpl(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t stdmeta) {
    ...
    @name("tmp_1") U tmp_7;
    @name("tmp_2") bool tmp_8;
    @name("tmp_3") H[1] tmp_9;
    @name("tmp_4") bool tmp_10;
    apply {

...
parser ParserImpl(packet_in packet, out headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name("Tcp_option_parser.tcp_hdr_bytes_left") bit<7> Tcp_option_parser_tcp_hdr_bytes_left_0;
    @name("Tcp_option_parser.n_sack_bytes") bit<8> Tcp_option_parser_n_sack_bytes_0;
    @name("Tcp_option_parser.tmp") bit<8> Tcp_option_parser_tmp_2;
    @name("Tcp_option_parser.tmp_0") bit<8> Tcp_option_parser_tmp_3;
    @name("Tcp_option_parser.tmp_1") Tcp_option_sack_top Tcp_option_parser_tmp_4;
    state start {
    ...
    state Tcp_option_parser_next_option_part2 {
        Tcp_option_parser_tmp_3 = packet.lookahead<bit<8>>();
        Tcp_option_parser_tmp_2 = Tcp_option_parser_tmp_3;
        transition select(Tcp_option_parser_tmp_2) {
    ...
    state Tcp_option_parser_parse_tcp_option_sack {
        Tcp_option_parser_tmp_4 = packet.lookahead<Tcp_option_sack_top>();
        Tcp_option_parser_n_sack_bytes_0 = Tcp_option_parser_tmp_4.length;
...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name("set_l2ptr") action set_l2ptr_0(@name("l2ptr") bit<32> l2ptr_1) {
    ...
    @name("set_bd_dmac_intf") action set_bd_dmac_intf_0(@name("bd") bit<24> bd, @name("dmac") bit<48> dmac, @name("intf") bit<9> intf) {
...
control egress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name("rewrite_mac") action rewrite_mac_0(@name("smac") bit<48> smac) {

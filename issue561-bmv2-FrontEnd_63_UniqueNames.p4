...
parser ParserImpl(packet_in packet, out headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name("Tcp_option_parser.tcp_hdr_bytes_left") bit<7> Tcp_option_parser_tcp_hdr_bytes_left;
    @name("Tcp_option_parser.n_sack_bytes") bit<8> Tcp_option_parser_n_sack_bytes;
    @name("Tcp_option_parser.tmp") bit<8> Tcp_option_parser_tmp;
    @name("Tcp_option_parser.tmp_0") bit<8> Tcp_option_parser_tmp_0;
    @name("Tcp_option_parser.tmp_1") Tcp_option_sack_top Tcp_option_parser_tmp_1;
    state start {
...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name("set_l2ptr") action set_l2ptr(@name("l2ptr") bit<32> l2ptr_1) {

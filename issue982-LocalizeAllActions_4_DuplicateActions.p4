...
control ingress(inout headers hdr, inout metadata user_meta, in psa_ingress_input_metadata_t istd, inout psa_ingress_output_metadata_t ostd) {
    ...
    @name("do_clone") action do_clone_0(@name("port") PortId_t port_0) {
        ostd.clone = true;
        ostd.clone_port = port_0;
        user_meta.custom_clone_id = 3w1;
    }
    @name("do_clone") action do_clone(@name("port") PortId_t port_0) {
        ostd.clone = true;
        ostd.clone_port = port_0;
        user_meta.custom_clone_id = 3w1;
    }
...
control IngressDeparserImpl(packet_out packet, inout headers hdr, in metadata meta, in psa_ingress_output_metadata_t istd, out psa_ingress_deparser_output_metadata_t ostd) {
    @name("clone_md") clone_metadata_t clone_md_0;
    apply {

...
control MyIngress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name("c") bool c_0 = true;
    @name("c1") bool c1_0 = true;
    @name("c2") bool c2_0 = true;
    @name("c3") bool c3_0 = true;
    @name("if_testing") action if_testing_0(out bit<16> value, in bit<8> offset) {
        value = 16w0;
        @name("x") bit<16> x_0 = hdr.ipv4.identification;
        @name("y") bit<16> y_0 = hdr.ipv4.hdrChecksum;
        @name("z") bit<16> z_0 = hdr.ipv4.totalLen;

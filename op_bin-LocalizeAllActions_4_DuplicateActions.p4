...
control pipe(inout Headers_t headers, out bool xout) {
    ...
    @name("set_flowlabel") action set_flowlabel_0(@name("label") bit<20> label_0) {
        headers.ipv6.ip_version_traffic_class_and_flow_label[31:12] = label_0;
    }
    @name("set_flowlabel") action set_flowlabel(@name("label") bit<20> label_0) {
        headers.ipv6.ip_version_traffic_class_and_flow_label[31:12] = label_0;
    }

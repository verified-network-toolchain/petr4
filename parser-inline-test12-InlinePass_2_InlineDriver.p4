...
parser Subparser(packet_in packet, out headers hdr, inout headers2 inout_hdr) {
    @name("shdr") headers2 shdr_0;
    state start {
        shdr_0.h1.setInvalid();
    ...
    state sp1 {
        ...
        packet.extract<data_t>(shdr_0.h1);
        inout_hdr.h1 = shdr_0.h1;
        transition accept;
    }
    state sp2 {
...
parser ParserImpl(packet_in packet, out headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name("phdr") headers2 phdr_0;
    @name("subp1") Subparser() subp1_0;
    @name("subp1.shdr") headers2 subp1_shdr;
    @name("subp2") Subparser() subp2_0;
    @name("subp2.shdr") headers2 subp2_shdr;
    state start {
    ...
    state Subparser_sp1 {
        packet.extract<data_t>(hdr.h3);
        packet.extract<data_t>(subp1_shdr.h1);
        phdr_0.h1 = subp1_shdr.h1;
        transition p0_0;
    }
    state Subparser_sp2 {
        packet.extract<data_t16>(hdr.h2);
    ...
    state Subparser_sp1_1 {
        packet.extract<data_t>(hdr.h3);
        packet.extract<data_t>(subp2_shdr.h1);
        phdr_0.h1 = subp2_shdr.h1;
        transition p2_0;
    }
    state Subparser_sp2_1 {
        packet.extract<data_t16>(hdr.h2);
        transition p2_0;
    }
    state p2_0 {
    ...
    state p3 {
        ...
        hdr.h3.setInvalid();
        hdr.h4.setInvalid();
        transition Subparser_start_2;
    }
    state Subparser_start_2 {
        subp2_shdr.h1.setInvalid();
        packet.extract<data_t>(hdr.h1);
        transition select(hdr.h1.f) {
            8w1: Subparser_sp1_2;
    ...
    state Subparser_sp1_2 {
        packet.extract<data_t>(hdr.h3);
        packet.extract<data_t>(subp2_shdr.h1);
        phdr_0.h1 = subp2_shdr.h1;
        transition p3_0;
    }
    state Subparser_sp2_2 {
        packet.extract<data_t16>(hdr.h2);
        transition p3_0;
    }
    state p3_0 {

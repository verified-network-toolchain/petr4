...
parser ParserImpl(packet_in packet, out headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name("phdr") headers2 phdr;
    @name("subp1.shdr") headers2 subp1_shdr_0;
    @name("subp2.shdr") headers2 subp2_shdr_0;
    state start {
        phdr.h1.setInvalid();
    ...
    state Subparser_sp1 {
        ...
        packet.extract<data_t>(subp1_shdr_0.h1);
        phdr.h1 = subp1_shdr_0.h1;
        transition p0_0;
    }
    state Subparser_sp2 {
    ...
    state Subparser_sp1_1 {
        packet.extract<data_t>(hdr.h3);
        packet.extract<data_t>(subp2_shdr_0.h1);
        phdr.h1 = subp2_shdr_0.h1;
        transition p2_0;
    }

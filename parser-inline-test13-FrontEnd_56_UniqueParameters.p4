...
parser ParserImpl(packet_in packet, out headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name("phdr") headers2 phdr_2;
    @name("hdr_0") headers hdr_1;
    @name("inout_hdr_0") headers2 inout_hdr;
    @name("p.shdr") headers2 p_shdr_0;
    state start {
    ...
    state Subparser_start {
        p_shdr_0.h1.setInvalid();
        packet.extract<data_t>(hdr_1.h1);
        transition select(hdr_1.h1.f) {
            8w1: Subparser_sp1;
            8w2: Subparser_sp2;
            default: p0_0;
        }
    ...
    state Subparser_sp1 {
        packet.extract<data_t>(hdr_1.h3);
        packet.extract<data_t>(p_shdr_0.h1);
        inout_hdr.h1 = p_shdr_0.h1;
        transition p0_0;
    }
    state Subparser_sp2 {
        packet.extract<data_t16>(hdr_1.h2);
        transition p0_0;
    }
    state p0_0 {
        hdr = hdr_1;
    ...
    state p1 {
        phdr_2.h1.setInvalid();
        packet.extract<data_t>(phdr_2.h1);
        hdr_1.h1.setInvalid();
        hdr_1.h2.setInvalid();
        hdr_1.h3.setInvalid();
        hdr_1.h4.setInvalid();

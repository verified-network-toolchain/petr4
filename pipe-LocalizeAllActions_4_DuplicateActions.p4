...
control Q_pipe(inout TArg1 qArg1, inout TArg2 qArg2) {
    ...
    @name("p1.thost.B_action") action p1_thost_B_action_0(@name("barg") out bit<9> barg_0, @name("bData") BParamType bData_0) {
        barg_0 = bData_0;
    }
    @name("p1.thost.C_action") action p1_thost_C_action(@name("cData") bit<9> cData_0) {
        qArg1.field1 = cData_0;
    }
    @name("p1.thost.C_action") action p1_thost_C_action_0(@name("cData") bit<9> cData_0) {
        qArg1.field1 = cData_0;
    }

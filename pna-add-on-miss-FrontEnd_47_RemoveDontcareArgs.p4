...
control MainControlImpl(inout headers_t hdr, inout main_metadata_t user_meta, in pna_main_input_metadata_t istd, inout pna_main_output_metadata_t ostd) {
    ...
    @name("ipv4_da") table ipv4_da_0 {
        ...
        actions = {
            @tableonly next_hop_0();
            @defaultonly add_on_miss_action_0();
        }
        add_on_miss = true;
        const default_action = add_on_miss_action_0();
    }
    ...
    @name("ipv4_da2") table ipv4_da2_0 {
        ...
        actions = {
            @tableonly next_hop2_0();
            @defaultonly add_on_miss_action2_0();
        }
        add_on_miss = true;
        const default_action = add_on_miss_action2_0();
    }
    apply {
        if (hdr.ipv4.isValid()) {
            ipv4_da_0.apply();

...
control MainControlImpl(inout headers_t hdr, inout main_metadata_t user_meta, in pna_main_input_metadata_t istd, inout pna_main_output_metadata_t ostd) {
    ...
    @name("next_hop") action next_hop_0(@name("vport") PortId_t vport_0) {
        send_to_port(vport_0);
    }
    @name("next_hop") action next_hop(@name("vport") PortId_t vport_0) {
        send_to_port(vport_0);
    }
    @name("add_on_miss_action") action add_on_miss_action_0() {
        tmp_0 = 32w0;
        add_entry<bit<32>>(action_name = "next_hop", action_params = tmp_0);
    }
    @name("add_on_miss_action") action add_on_miss_action() {
        tmp_0 = 32w0;
        add_entry<bit<32>>(action_name = "next_hop", action_params = tmp_0);
    }
    @name("ipv4_da") table ipv4_da_0 {
        key = {
    ...
    @name("next_hop2") action next_hop2_0(@name("vport") PortId_t vport_1, @name("newAddr") bit<32> newAddr_0) {
        send_to_port(vport_1);
        hdr.ipv4.srcAddr = newAddr_0;
    }
    @name("next_hop2") action next_hop2(@name("vport") PortId_t vport_1, @name("newAddr") bit<32> newAddr_0) {
        send_to_port(vport_1);
        hdr.ipv4.srcAddr = newAddr_0;
    }
    @name("add_on_miss_action2") action add_on_miss_action2_0() {
        add_entry<tuple<bit<32>, bit<32>>>(action_name = "next_hop", action_params = { 32w0, 32w1234 });
    }
    @name("add_on_miss_action2") action add_on_miss_action2() {
        add_entry<tuple<bit<32>, bit<32>>>(action_name = "next_hop", action_params = { 32w0, 32w1234 });
    }
    @name("ipv4_da2") table ipv4_da2_0 {
        key = {
            hdr.ipv4.dstAddr: exact @name("hdr.ipv4.dstAddr") ;
        }
        actions = {

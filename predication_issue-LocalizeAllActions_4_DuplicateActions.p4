...
@name(".assign_addrs") action assign_addrs(@name("h") inout Headers h_0, @name("check_1") bool check, @name("check_2") bool check_0) {
...
control ingress(inout Headers h, inout Meta m, inout standard_metadata_t sm) {
    @name(".assign_addrs") action assign_addrs_0(@name("h") inout Headers h_0, @name("check_1") bool check, @name("check_2") bool check_0) {
        h_0.eth_hdr.dst_addr = 48w4;
        if (check) {
            h_0.eth_hdr.dst_addr = 48w2;
            if (check_0) {
    ...
    @name(".assign_addrs") action assign_addrs_1(@name("h") inout Headers h_0, @name("check_1") bool check, @name("check_2") bool check_0) {
        h_0.eth_hdr.dst_addr = 48w4;
        if (check) {
            h_0.eth_hdr.dst_addr = 48w2;
            if (check_0) {

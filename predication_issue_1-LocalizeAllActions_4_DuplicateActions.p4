...
@name(".assign") action assign(@name("eth_t") inout bit<16> eth_t_0, @name("target_addr") inout bit<48> target_addr_0, @name("check_bool") bool check_bool_0) {
    bool tmp;
    bool tmp_0;
    if (check_bool_0) {
        tmp = simple_check();
...
control ingress(inout Headers h, inout Meta m, inout standard_metadata_t sm) {
    @name(".assign") action assign_0(@name("eth_t") inout bit<16> eth_t_0, @name("target_addr") inout bit<48> target_addr_0, @name("check_bool") bool check_bool_0) {
        bool tmp;
        bool tmp_0;
        if (check_bool_0) {
            tmp = simple_check();
    ...
    @name(".assign") action assign_1(@name("eth_t") inout bit<16> eth_t_0, @name("target_addr") inout bit<48> target_addr_0, @name("check_bool") bool check_bool_0) {
        bool tmp;
        bool tmp_0;
        if (check_bool_0) {
            tmp = simple_check();
    ...
    apply {
        assign_1(h.eth_hdr.eth_type, h.eth_hdr.dst_addr, true);
    }
}

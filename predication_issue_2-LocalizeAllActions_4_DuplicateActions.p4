...
control ingress(inout Headers h, inout Meta m, inout standard_metadata_t sm) {
    ...
    @name("simple_action") action simple_action_0(@name("check") bool check_0) {
        if (check_0) {
            val_0 = bound(h.idx.idx, 8w1);
            h.h[val_0].a = 8w1;
        }
    }
    @name("simple_action") action simple_action(@name("check") bool check_0) {
        if (check_0) {
            val_0 = bound(h.idx.idx, 8w1);
            h.h[val_0].a = 8w1;
        }

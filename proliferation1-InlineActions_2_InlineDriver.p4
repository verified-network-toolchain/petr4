...
control MyIngress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name("do_round") action do_round_0(@name("x") inout bit<16> x_0) {
    ...
    @name("do_n_rounds") action do_n_rounds_0(@name("x") inout bit<16> x_1) {
        ...
        {
            @name("x") bit<16> x_2 = x_1;
            x_2 = x_2 + 16w65535 & x_2;
            x_1 = x_2;
        }
        {
            @name("x") bit<16> x_3 = x_1;
            x_3 = x_3 + 16w65535 & x_3;
            x_1 = x_3;
        }
        {
            @name("x") bit<16> x_4 = x_1;
            x_4 = x_4 + 16w65535 & x_4;
            x_1 = x_4;
        }
        {
            @name("x") bit<16> x_5 = x_1;
            x_5 = x_5 + 16w65535 & x_5;
            x_1 = x_5;
        }
        {
            @name("x") bit<16> x_6 = x_1;
            x_6 = x_6 + 16w65535 & x_6;
            x_1 = x_6;
        }
        {
            @name("x") bit<16> x_7 = x_1;
            x_7 = x_7 + 16w65535 & x_7;
            x_1 = x_7;
        }
        {
            @name("x") bit<16> x_8 = x_1;
            x_8 = x_8 + 16w65535 & x_8;
            x_1 = x_8;
        }
        {
            @name("x") bit<16> x_9 = x_1;
            x_9 = x_9 + 16w65535 & x_9;
            x_1 = x_9;
        }
        {
            @name("x") bit<16> x_10 = x_1;
            x_10 = x_10 + 16w65535 & x_10;
            x_1 = x_10;
        }
        {
            @name("x") bit<16> x_11 = x_1;
            x_11 = x_11 + 16w65535 & x_11;
            x_1 = x_11;
        }
        {
            @name("x") bit<16> x_12 = x_1;
            x_12 = x_12 + 16w65535 & x_12;
            x_1 = x_12;
        }
        {
            @name("x") bit<16> x_13 = x_1;

...
control ingress(inout headers hdr, inout metadata meta, in psa_ingress_input_metadata_t istd, inout psa_ingress_output_metadata_t ostd) {
    ...
    @name("do_L2_forward") action do_L2_forward_0(@name("egress_port") PortId_t egress_port_1) {
        @noWarnUnused {
            @name("meta") psa_ingress_output_metadata_t meta_1 = ostd;
            @name("egress_port") PortId_t egress_port_3 = egress_port_1;
            meta_1.drop = false;
    ...
    @name("do_L2_forward") action do_L2_forward(@name("egress_port") PortId_t egress_port_1) {
        @noWarnUnused {
            @name("meta") psa_ingress_output_metadata_t meta_1 = ostd;
            @name("egress_port") PortId_t egress_port_3 = egress_port_1;
            meta_1.drop = false;
    ...
    @name("do_tst") action do_tst_0(@name("egress_port") PortId_t egress_port_2, @name("serEnumT") EthTypes serEnumT_0) {
        @noWarnUnused {
            @name("meta") psa_ingress_output_metadata_t meta_2 = ostd;
            @name("egress_port") PortId_t egress_port_4 = egress_port_2;
            meta_2.drop = false;
    ...
    @name("do_tst") action do_tst(@name("egress_port") PortId_t egress_port_2, @name("serEnumT") EthTypes serEnumT_0) {
        @noWarnUnused {
            @name("meta") psa_ingress_output_metadata_t meta_2 = ostd;
            @name("egress_port") PortId_t egress_port_4 = egress_port_2;
            meta_2.drop = false;

...
control ingress(inout headers hdr, inout metadata meta, in psa_ingress_input_metadata_t istd, inout psa_ingress_output_metadata_t ostd) {
    ...
    @name("do_L2_forward") action do_L2_forward(@name("egress_port") PortId_t egress_port_3) {
        @noWarnUnused {
            meta_1 = ostd;
    ...
    @name("do_tst") action do_tst(@name("egress_port") PortId_t egress_port_4, @name("serEnumT") EthTypes serEnumT) {
        @noWarnUnused {
            meta_2 = ostd;

...
control ingress(inout headers hdr, inout metadata meta, in psa_ingress_input_metadata_t istd, inout psa_ingress_output_metadata_t ostd) {
    @name("meta") psa_ingress_output_metadata_t meta_0;
    @name("egress_port") PortId_t egress_port_0;
    @name("meta") psa_ingress_output_metadata_t meta_3;
    @name("egress_port") PortId_t egress_port_5;
    ...
    @name("do_L2_forward") action do_L2_forward_0(@name("egress_port") PortId_t egress_port_3) {
        @noWarnUnused {
            meta_0 = ostd;
            egress_port_0 = egress_port_3;
            meta_0.drop = false;
    ...
    @name("do_tst") action do_tst_0(@name("egress_port") PortId_t egress_port_4, @name("serEnumT") EthTypes serEnumT) {
        @noWarnUnused {
            meta_3 = ostd;
            egress_port_5 = egress_port_4;
            meta_3.drop = false;
            meta_3.multicast_group = (MulticastGroup_t)32w0;
            meta_3.egress_port = egress_port_5;
            ostd = meta_3;
        }
    }

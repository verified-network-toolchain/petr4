...
@noWarnUnused action ingress_drop(@name("meta") inout psa_ingress_output_metadata_t meta_1) {
    meta_1.drop = true;
}
...
control ingress(inout headers hdr, inout metadata user_meta, in psa_ingress_input_metadata_t istd, inout psa_ingress_output_metadata_t ostd) {
    ...
    @name("forward") action forward_0(@name("port") PortId_t port_0, @name("srcAddr") bit<32> srcAddr_0) {
        user_meta.fwd_metadata.old_srcAddr = hdr.ipv4.srcAddr;
        hdr.ipv4.srcAddr = srcAddr_0;
        @noWarnUnused {
            @name("meta") psa_ingress_output_metadata_t meta_3 = ostd;
            @name("egress_port") PortId_t egress_port_1 = port_0;
            meta_3.drop = false;

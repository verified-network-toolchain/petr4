...
@noWarnUnused @name(".ingress_drop") action ingress_drop(@name("meta") inout psa_ingress_output_metadata_t meta_0) {
    meta_0.drop = true;
}
...
control ingress(inout headers hdr, inout metadata user_meta, in psa_ingress_input_metadata_t istd, inout psa_ingress_output_metadata_t ostd) {
    @noWarnUnused @name(".ingress_drop") action ingress_drop_0(@name("meta") inout psa_ingress_output_metadata_t meta_0) {
        meta_0.drop = true;
    }
    @noWarnUnused @name(".ingress_drop") action ingress_drop_1(@name("meta") inout psa_ingress_output_metadata_t meta_0) {
        meta_0.drop = true;
    }
    @name("parser_error_counts") DirectCounter<PacketCounter_t>(PSA_CounterType_t.PACKETS) parser_error_counts_0;
    @name("set_error_idx") action set_error_idx_0(@name("idx") ErrorIndex_t idx_0) {
        parser_error_counts_0.count();
    }
    @name("set_error_idx") action set_error_idx(@name("idx") ErrorIndex_t idx_0) {
        parser_error_counts_0.count();
    }

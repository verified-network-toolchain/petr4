...
@name(".update_pkt_ip_byte_count") action update_pkt_ip_byte_count(@name("s") inout PacketByteCountState_t s_0, @name("ip_length_bytes") in bit<16> ip_length_bytes_0) {
...
control ingress(inout headers hdr, inout metadata user_meta, in psa_ingress_input_metadata_t istd, inout psa_ingress_output_metadata_t ostd) {
    @name(".update_pkt_ip_byte_count") action update_pkt_ip_byte_count_0(@name("s") inout PacketByteCountState_t s_0, @name("ip_length_bytes") in bit<16> ip_length_bytes_0) {
        s_0[79:48] = s_0[79:48] + 32w1;
        s_0[47:0] = s_0[47:0] + (bit<48>)ip_length_bytes_0;
    }
    @name(".update_pkt_ip_byte_count") action update_pkt_ip_byte_count_1(@name("s") inout PacketByteCountState_t s_0, @name("ip_length_bytes") in bit<16> ip_length_bytes_0) {
        s_0[79:48] = s_0[79:48] + 32w1;
        s_0[47:0] = s_0[47:0] + (bit<48>)ip_length_bytes_0;
    }
    @name("tmp") PacketByteCountState_t tmp_0;
    ...
    apply {
        ...
        if (hdr.ipv4.isValid()) @atomic {
            ...
            update_pkt_ip_byte_count_1(tmp_0, hdr.ipv4.totalLen);

...
control MyIC(inout headers_t hdr, inout EMPTY b, in psa_ingress_input_metadata_t c, inout psa_ingress_output_metadata_t d) {
    ...
    @name("a1") action a1_3(@name("param") bit<48> param_0) {
        hdr.ethernet.dstAddr = param_0;
    }
    @name("a1") action a1_4(@name("param") bit<48> param_0) {
        hdr.ethernet.dstAddr = param_0;
    }
    @name("a2") action a2_0(@name("param") bit<16> param_1) {
        hdr.ethernet.etherType = param_1;
    }
    @name("a2") action a2_3(@name("param") bit<16> param_1) {
        hdr.ethernet.etherType = param_1;
    }
    @name("a2") action a2_4(@name("param") bit<16> param_1) {
        hdr.ethernet.etherType = param_1;
    }
    @name("tbl_idle_timeout") table tbl_idle_timeout {
        key = {
    ...
    @name("tbl_no_idle_timeout") table tbl_no_idle_timeout {
        key = {
    ...
    @name("tbl_no_idle_timeout_prop") table tbl_no_idle_timeout_prop {
        key = {
            hdr.ethernet.srcAddr2: exact @name("hdr.ethernet.srcAddr2") ;
        }
        actions = {

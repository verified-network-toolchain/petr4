...
control MyIC(inout headers_t hdr, inout EMPTY b, in psa_ingress_input_metadata_t c, inout psa_ingress_output_metadata_t d) {
    ...
    @name("execute") action execute_0(@name("index") bit<12> index_0, @name("color") PSA_MeterColor_t color_0) {
        meter0_0.execute(index_0, color_0);
    }
    @name("execute") action execute_1(@name("index") bit<12> index_0, @name("color") PSA_MeterColor_t color_0) {
        meter0_0.execute(index_0, color_0);
    }

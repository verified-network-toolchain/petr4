...
@noWarnUnused @name(".multicast") action multicast(@name("meta") inout psa_ingress_output_metadata_t meta_0, @name("multicast_group") in MulticastGroup_t multicast_group_0) {
    meta_0.drop = false;
...
control cIngress(inout headers_t hdr, inout metadata_t user_meta, in psa_ingress_input_metadata_t istd, inout psa_ingress_output_metadata_t ostd) {
    @noWarnUnused @name(".multicast") action multicast_0(@name("meta") inout psa_ingress_output_metadata_t meta_0, @name("multicast_group") in MulticastGroup_t multicast_group_0) {
        meta_0.drop = false;
        meta_0.multicast_group = multicast_group_0;
    }
    @noWarnUnused @name(".multicast") action multicast_1(@name("meta") inout psa_ingress_output_metadata_t meta_0, @name("multicast_group") in MulticastGroup_t multicast_group_0) {
        meta_0.drop = false;
        meta_0.multicast_group = multicast_group_0;
    }
    apply {

...
control cIngress(inout headers_t hdr, inout metadata_t user_meta, in psa_ingress_input_metadata_t istd, inout psa_ingress_output_metadata_t ostd) {
    @name("int_packet_path") bit<32> int_packet_path;
    ...
    @noWarnUnused @name(".send_to_port") action send_to_port() {
        meta_1 = ostd;
        egress_port_1 = (PortId_t)(PortIdUint_t)hdr.ethernet.dstAddr;
        meta_1.drop = false;
        meta_1.multicast_group = (MulticastGroup_t)32w0;
        meta_1.egress_port = egress_port_1;
        ostd = meta_1;
    }
    @name("meta") psa_ingress_output_metadata_t meta_2;
    @name("egress_port") PortId_t egress_port_2;
    @noWarnUnused @name(".send_to_port") action send_to_port_0() {
        meta_2 = ostd;
        egress_port_2 = (PortId_t)32w0xfffffffa;
        meta_2.drop = false;

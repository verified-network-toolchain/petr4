...
control cIngress(inout headers_t hdr, inout metadata_t user_meta, in psa_ingress_input_metadata_t istd, inout psa_ingress_output_metadata_t ostd) {
    @name("tmp") bit<48> tmp_4;
    @name("tmp_0") bit<48> tmp_5;
    @name("tmp_1") bit<48> tmp_6;
    @name("tmp_2") bit<48> tmp_7;
    @name("tmp_3") bit<48> tmp_8;
    ...
    @name("regfile") Register<EthernetAddress, bit<32>>(32w128) regfile;
    apply {
        regfile.write(32w1, 48w3);
        regfile.write(32w2, 48w4);
        tmp_5 = regfile.read(32w1);
        tmp_4 = tmp_5;
        tmp_6 = regfile.read(32w2);
        tmp_7 = tmp_4 + tmp_6;
        tmp_8 = tmp_7 + 48w281474976710651;
        hdr.ethernet.dstAddr = tmp_8;

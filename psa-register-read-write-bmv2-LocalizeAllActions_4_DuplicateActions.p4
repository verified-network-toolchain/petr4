...
control cIngress(inout headers_t hdr, inout metadata_t user_meta, in psa_ingress_input_metadata_t istd, inout psa_ingress_output_metadata_t ostd) {
    ...
    @noWarnUnused @name(".ingress_drop") action ingress_drop_0(@name("meta") inout psa_ingress_output_metadata_t meta_1) {
        meta_1.drop = true;
    }
    @noWarnUnused @name(".ingress_drop") action ingress_drop_1(@name("meta") inout psa_ingress_output_metadata_t meta_1) {
        meta_1.drop = true;
    }
    @name("regfile") Register<EthernetAddress, bit<32>>(32w128) regfile_0;
    apply {

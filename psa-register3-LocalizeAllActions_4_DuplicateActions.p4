...
control MyIC(inout headers_t hdr, inout user_meta_t b, in psa_ingress_input_metadata_t c, inout psa_ingress_output_metadata_t d) {
    ...
    @name("execute_register") action execute_register_0(@name("idx") bit<10> idx_0) {
        reg_0.write(idx_0, b.data);
    }
    @name("execute_register") action execute_register(@name("idx") bit<10> idx_0) {
        reg_0.write(idx_0, b.data);
    }

...
control MyIC(inout headers_t hdr, inout EMPTY_M b, in psa_ingress_input_metadata_t c, inout psa_ingress_output_metadata_t d) {
    ...
    @name("remove_header") action remove_header_0() {
        hdr.ethernet.setInvalid();
    }
    @name("remove_header") action remove_header() {
        hdr.ethernet.setInvalid();
    }
    ...
    @name("ifHit") action ifHit_0() {
        hdr.ethernet.setInvalid();
    }
    @name("ifHit") action ifHit() {
        hdr.ethernet.setInvalid();
    }
    @name("ifHit") action ifHit_1() {
        hdr.ethernet.setInvalid();
    }
    @name("ifMiss") action ifMiss_0() {
        hdr.ethernet.setValid();
    }
    @name("ifMiss") action ifMiss() {
        hdr.ethernet.setValid();
    }
    @name("ifMiss") action ifMiss_1() {
        hdr.ethernet.setValid();
    }
    apply {
        if (tbl_0.apply().hit) {

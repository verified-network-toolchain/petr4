...
control c(out bit<32> x, out bit<32> y) {
    ...
    apply {
        ...
        if (b_0) {
            ...
            {
                @name("a_3") bit<32> a_10;
                @name("hasReturned") bool hasReturned_4;
                @name("retval") bit<32> retval_4;
                hasReturned_4 = false;
                a_10 = 32w0;
                hasReturned_4 = true;
                retval_4 = a_10;
            ...
            {
                @name("a_5") bit<32> a_12 = h_0.a;
                @name("hasReturned_0") bool hasReturned_6;
                @name("retval_0") bit<32> retval_6;
                hasReturned_6 = false;
                hasReturned_6 = true;
                retval_6 = a_12;
                x = retval_6;

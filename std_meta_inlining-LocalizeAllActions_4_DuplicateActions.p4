...
@name(".send_to_cpu") action send_to_cpu(@name("standard_metadata") inout standard_metadata_t standard_metadata_0) {
    standard_metadata_0.egress_spec = 9w64;
}
control ingress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    @name(".send_to_cpu") action send_to_cpu_0(@name("standard_metadata") inout standard_metadata_t standard_metadata_0) {
        standard_metadata_0.egress_spec = 9w64;
    }
    @name(".send_to_cpu") action send_to_cpu_1(@name("standard_metadata") inout standard_metadata_t standard_metadata_0) {
        standard_metadata_0.egress_spec = 9w64;
    }

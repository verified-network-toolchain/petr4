...
control ingress(inout Header_t h, inout Meta_t m, inout standard_metadata_t standard_meta) {
    ...
    @name("a_with_control_params") action a_with_control_params_0(@name("x") bit<9> x_0) {
        standard_meta.egress_spec = x_0;
    }
    @name("t_optional") table t_optional_0 {
        key = {
        ...
        default_action = a_0();
        const entries = {
                        (8w0xaa, 16w0x1111) : a_with_control_params_0(9w1);
                        (default, 16w0x1111) : a_with_control_params_0(9w2);
                        (8w0xaa, default) : a_with_control_params_0(9w3);
                        (default, default) : a_with_control_params_0(9w4);
        }
    }
    apply {
        t_optional_0.apply();

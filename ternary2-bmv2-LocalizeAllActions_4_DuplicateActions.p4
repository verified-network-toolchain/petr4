...
control ingress(inout packet_t hdrs, inout Meta m, inout standard_metadata_t meta) {
    @name("setb1") action setb1_0(@name("port") bit<9> port_0, @name("val") bit<8> val_0) {
        hdrs.data.b1 = val_0;
        meta.egress_spec = port_0;
    }
    @name("setb1") action setb1(@name("port") bit<9> port_0, @name("val") bit<8> val_0) {
        hdrs.data.b1 = val_0;
        meta.egress_spec = port_0;
    }
    ...
    @name("setbyte") action setbyte_0(@name("reg") out bit<8> reg_0, @name("val") bit<8> val_1) {
        reg_0 = val_1;
    }
    @name("setbyte") action setbyte(@name("reg") out bit<8> reg_0, @name("val") bit<8> val_1) {
        reg_0 = val_1;
    }
    @name("setbyte") action setbyte_1(@name("reg") out bit<8> reg_0, @name("val") bit<8> val_1) {
        reg_0 = val_1;
    }
    @name("setbyte") action setbyte_2(@name("reg") out bit<8> reg_0, @name("val") bit<8> val_1) {
        reg_0 = val_1;
    }
    @name("setbyte") action setbyte_3(@name("reg") out bit<8> reg_0, @name("val") bit<8> val_1) {
        reg_0 = val_1;
    }
    @name("act1") action act1_0(@name("val") bit<8> val_2) {
        hdrs.extra[0].b1 = val_2;
    }
    @name("act1") action act1(@name("val") bit<8> val_2) {
        hdrs.extra[0].b1 = val_2;
    }
    @name("act2") action act2_0(@name("val") bit<8> val_3) {
        hdrs.extra[0].b1 = val_3;
    }
    @name("act2") action act2(@name("val") bit<8> val_3) {
        hdrs.extra[0].b1 = val_3;
    }
    @name("act3") action act3_0(@name("val") bit<8> val_4) {
        hdrs.extra[0].b1 = val_4;
    }
    @name("act3") action act3(@name("val") bit<8> val_4) {
        hdrs.extra[0].b1 = val_4;
    }

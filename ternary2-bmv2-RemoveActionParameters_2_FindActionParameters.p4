...
control ingress(inout packet_t hdrs, inout Meta m, inout standard_metadata_t meta) {
    ...
    @name("setbyte") action setbyte_0(@name("reg") out bit<8> reg, @name("val") bit<8> val_5) {
        reg = val_5;
    }
    @name("setbyte") action setbyte_4(@name("reg") out bit<8> reg_1, @name("val") bit<8> val_6) {
        reg_1 = val_6;
    }
    @name("setbyte") action setbyte_5(@name("reg") out bit<8> reg_2, @name("val") bit<8> val_7) {
        reg_2 = val_7;
    }
    @name("setbyte") action setbyte_6(@name("reg") out bit<8> reg_3, @name("val") bit<8> val_8) {
        reg_3 = val_8;
    }

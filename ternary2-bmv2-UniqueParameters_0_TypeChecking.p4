...
control ingress(inout packet_t hdrs, inout Meta m, inout standard_metadata_t meta) {
    ...
    @name("setbyte") action setbyte_4(@name("reg") out bit<8> reg_0, @name("val") bit<8> val_1) {
        reg_0 = val_1;
    }
    @name("setbyte") action setbyte_5(@name("reg") out bit<8> reg_0, @name("val") bit<8> val_1) {
        reg_0 = val_1;
    }
    @name("setbyte") action setbyte_6(@name("reg") out bit<8> reg_0, @name("val") bit<8> val_1) {
        reg_0 = val_1;
    }

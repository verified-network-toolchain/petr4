...
control ingressImpl(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t stdmeta) {
    @name("act_miss") action act_miss_0() {
        hdr.ethernet.srcAddr = 48w0xdeadbeef;
    }
    @name("act_hit") action act_hit_0(@name("x") bit<48> x_0) {
        hdr.ethernet.srcAddr = x_0;
    }
    @name("lpm1") table lpm1_0 {
        key = {
        ...
        const entries = {
                        48w0xa0102030000 : act_hit_0(48w1);
                        48w0xa0000000000 &&& 48w0xff0000000000 : act_hit_0(48w2);
                        48w0x0 &&& 48w0x0 : act_hit_0(48w3);
        }
        const default_action = act_miss_0();
    }
    apply {
        lpm1_0.apply();

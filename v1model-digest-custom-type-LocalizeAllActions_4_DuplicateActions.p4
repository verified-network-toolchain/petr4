...
control MyIngress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name("set_dmac") action set_dmac_0(@name("dstAddr") EthernetAddr_t dstAddr_0) {
        hdr.ethernet.dstAddr = dstAddr_0;
    }
    @name("set_dmac") action set_dmac(@name("dstAddr") EthernetAddr_t dstAddr_0) {
        hdr.ethernet.dstAddr = dstAddr_0;
    }
    ...
    @name("set_nhop") action set_nhop_0(@name("dstAddr") IPv4Addr_t dstAddr_1, @name("port") egressSpec_t port_0) {
        hdr.ipv4.dstAddr = dstAddr_1;
        standard_metadata.egress_spec = port_0;
    }
    @name("set_nhop") action set_nhop(@name("dstAddr") IPv4Addr_t dstAddr_1, @name("port") egressSpec_t port_0) {
        hdr.ipv4.dstAddr = dstAddr_1;
        standard_metadata.egress_spec = port_0;
    }
...
control MyEgress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name("rewrite_mac") action rewrite_mac_0(@name("srcAddr") EthernetAddr_t srcAddr_0) {
        hdr.ethernet.srcAddr = srcAddr_0;
        hdr.ipv4.ttl = hdr.ipv4.ttl + 8w255;
    }
    @name("rewrite_mac") action rewrite_mac(@name("srcAddr") EthernetAddr_t srcAddr_0) {
        hdr.ethernet.srcAddr = srcAddr_0;
        hdr.ipv4.ttl = hdr.ipv4.ttl + 8w255;
    }

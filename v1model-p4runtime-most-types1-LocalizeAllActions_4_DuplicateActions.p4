...
control ingress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t stdmeta) {
    @name("set_output") action set_output_0(@name("out_port") bit<9> out_port_0) {
        stdmeta.egress_spec = out_port_0;
    }
    @name("set_output") action set_output(@name("out_port") bit<9> out_port_0) {
        stdmeta.egress_spec = out_port_0;
    }
    @name("set_headers") action set_headers_0(@name("addr0") Eth0_t addr0_0, @name("addr1") Eth1_t addr1_0, @name("addr2") Eth2_t addr2_0, @name("e") bit<8> e_0, @name("e0") Custom0_t e0_0, @name("e1") Custom1_t e1_0, @name("e2") Custom2_t e2_0, @name("e00") Custom00_t e00_0, @name("e01") Custom01_t e01_0, @name("e02") Custom02_t e02_0, @name("e10") Custom10_t e10_0, @name("e11") Custom11_t e11_0, @name("e12") Custom12_t e12_0, @name("e20") Custom20_t e20_0, @name("e21") Custom21_t e21_0, @name("e22") Custom22_t e22_0, @name("e001") Custom001_t e001_0, @name("e002") Custom002_t e002_0, @name("e101") Custom101_t e101_0, @name("e102") Custom102_t e102_0, @name("e201") Custom201_t e201_0, @name("e202") Custom202_t e202_0, @name("e220") Custom220_t e220_0, @name("e0020010") Custom0020010_t e0020010_0, @name("e0020020") Custom0020020_t e0020020_0, @name("s0") serenum0_t s0_0) {
        hdr.custom.addr0 = addr0_0;
        hdr.custom.addr1 = addr1_0;
        hdr.custom.addr2 = addr2_0;
        hdr.custom.e = e_0;
        hdr.custom.e0 = e0_0;
        hdr.custom.e1 = e1_0;
        hdr.custom.e2 = e2_0;
        hdr.custom.e00 = e00_0;
        hdr.custom.e01 = e01_0;
        hdr.custom.e02 = e02_0;
        hdr.custom.e10 = e10_0;
        hdr.custom.e11 = e11_0;
        hdr.custom.e12 = e12_0;
        hdr.custom.e20 = e20_0;
        hdr.custom.e21 = e21_0;
        hdr.custom.e22 = e22_0;
        hdr.custom.e001 = e001_0;
        hdr.custom.e002 = e002_0;
        hdr.custom.e101 = e101_0;
        hdr.custom.e102 = e102_0;
        hdr.custom.e201 = e201_0;
        hdr.custom.e202 = e202_0;
        hdr.custom.e220 = e220_0;
        hdr.custom.e0020010 = e0020010_0;
        hdr.custom.e0020020 = e0020020_0;
        hdr.custom.s0 = s0_0;
    }
    @name("set_headers") action set_headers(@name("addr0") Eth0_t addr0_0, @name("addr1") Eth1_t addr1_0, @name("addr2") Eth2_t addr2_0, @name("e") bit<8> e_0, @name("e0") Custom0_t e0_0, @name("e1") Custom1_t e1_0, @name("e2") Custom2_t e2_0, @name("e00") Custom00_t e00_0, @name("e01") Custom01_t e01_0, @name("e02") Custom02_t e02_0, @name("e10") Custom10_t e10_0, @name("e11") Custom11_t e11_0, @name("e12") Custom12_t e12_0, @name("e20") Custom20_t e20_0, @name("e21") Custom21_t e21_0, @name("e22") Custom22_t e22_0, @name("e001") Custom001_t e001_0, @name("e002") Custom002_t e002_0, @name("e101") Custom101_t e101_0, @name("e102") Custom102_t e102_0, @name("e201") Custom201_t e201_0, @name("e202") Custom202_t e202_0, @name("e220") Custom220_t e220_0, @name("e0020010") Custom0020010_t e0020010_0, @name("e0020020") Custom0020020_t e0020020_0, @name("s0") serenum0_t s0_0) {
        hdr.custom.addr0 = addr0_0;
        hdr.custom.addr1 = addr1_0;
        hdr.custom.addr2 = addr2_0;
        hdr.custom.e = e_0;

...
control ingress(inout headers_t hdr, inout meta_t meta, inout standard_metadata_t standard_metadata) {
    ...
    @name("set_l2ptr") action set_l2ptr_0(@name("l2ptr") bit<32> l2ptr_0) {
        meta.fwd.l2ptr = l2ptr_0;
    }
    @name("set_l2ptr") action set_l2ptr(@name("l2ptr") bit<32> l2ptr_0) {
        meta.fwd.l2ptr = l2ptr_0;
    }
    @name("set_mcast_grp") action set_mcast_grp_0(@name("mcast_grp") bit<16> mcast_grp_0) {
        standard_metadata.mcast_grp = mcast_grp_0;
    }
    @name("set_mcast_grp") action set_mcast_grp(@name("mcast_grp") bit<16> mcast_grp_0) {
        standard_metadata.mcast_grp = mcast_grp_0;
    }
    @name("do_resubmit") action do_resubmit_0(@name("new_ipv4_dstAddr") bit<32> new_ipv4_dstAddr_0) {
        hdr.ipv4.dstAddr = new_ipv4_dstAddr_0;
        resubmit_preserving_field_list(8w0);
    }
    @name("do_resubmit") action do_resubmit(@name("new_ipv4_dstAddr") bit<32> new_ipv4_dstAddr_0) {
        hdr.ipv4.dstAddr = new_ipv4_dstAddr_0;
        resubmit_preserving_field_list(8w0);
    }
    @name("do_clone_i2e") action do_clone_i2e_0(@name("l2ptr") bit<32> l2ptr_1) {
        clone_preserving_field_list(CloneType.I2E, 32w5, 8w0);
        meta.fwd.l2ptr = l2ptr_1;
    }
    @name("do_clone_i2e") action do_clone_i2e(@name("l2ptr") bit<32> l2ptr_1) {
        clone_preserving_field_list(CloneType.I2E, 32w5, 8w0);
        meta.fwd.l2ptr = l2ptr_1;
    }
...
control egress(inout headers_t hdr, inout meta_t meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".my_drop") action my_drop_4(@name("smeta") inout standard_metadata_t smeta_0) {
        mark_to_drop(smeta_0);
    }
    @name("set_out_bd") action set_out_bd_0(@name("bd") bit<24> bd_1) {
        meta.fwd.out_bd = bd_1;
    }
    @name("set_out_bd") action set_out_bd(@name("bd") bit<24> bd_1) {
        meta.fwd.out_bd = bd_1;
    }
    ...
    @name("do_recirculate") action do_recirculate_0(@name("new_ipv4_dstAddr") bit<32> new_ipv4_dstAddr_1) {
        hdr.ipv4.dstAddr = new_ipv4_dstAddr_1;
        recirculate_preserving_field_list(8w0);
    }
    @name("do_recirculate") action do_recirculate(@name("new_ipv4_dstAddr") bit<32> new_ipv4_dstAddr_1) {
        hdr.ipv4.dstAddr = new_ipv4_dstAddr_1;
        recirculate_preserving_field_list(8w0);
    }
    @name("do_clone_e2e") action do_clone_e2e_0(@name("smac") bit<48> smac_1) {
        hdr.ethernet.srcAddr = smac_1;
        clone_preserving_field_list(CloneType.E2E, 32w11, 8w0);
    }
    @name("do_clone_e2e") action do_clone_e2e(@name("smac") bit<48> smac_1) {
        hdr.ethernet.srcAddr = smac_1;
        clone_preserving_field_list(CloneType.E2E, 32w11, 8w0);
    }

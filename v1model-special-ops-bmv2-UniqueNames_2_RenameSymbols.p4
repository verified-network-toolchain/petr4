...
control ingress(inout headers_t hdr, inout meta_t meta, inout standard_metadata_t standard_metadata) {
    @name("ipv4_address_0") bit<32> ipv4_address_0;
    @name("byte0_0") bit<8> byte0_0;
    @name("byte1_0") bit<8> byte1_0;
    @name("byte2_0") bit<8> byte2_0;
    @name("byte3_0") bit<8> byte3_0;
    @name("smeta") standard_metadata_t smeta_0;
    @name(".my_drop") action my_drop_2() {
        smeta_0 = standard_metadata;
        mark_to_drop(smeta_0);
        standard_metadata = smeta_0;
    }
    @name("smeta") standard_metadata_t smeta_3;
    @name(".my_drop") action my_drop_3() {
        smeta_3 = standard_metadata;
        mark_to_drop(smeta_3);
        standard_metadata = smeta_3;
    }
    @name("set_l2ptr") action set_l2ptr(@name("l2ptr") bit<32> l2ptr_2) {
        meta.fwd.l2ptr = l2ptr_2;
    }
    @name("set_mcast_grp") action set_mcast_grp(@name("mcast_grp") bit<16> mcast_grp_1) {
        standard_metadata.mcast_grp = mcast_grp_1;
    }
    @name("do_resubmit") action do_resubmit(@name("new_ipv4_dstAddr") bit<32> new_ipv4_dstAddr) {
        hdr.ipv4.dstAddr = new_ipv4_dstAddr;
        resubmit_preserving_field_list(8w0);
    }
    @name("do_clone_i2e") action do_clone_i2e(@name("l2ptr") bit<32> l2ptr_3) {
    ...
    @name("set_bd_dmac_intf") action set_bd_dmac_intf(@name("bd") bit<24> bd, @name("dmac") bit<48> dmac, @name("intf") bit<9> intf) {
        meta.fwd.out_bd = bd;
...
control egress(inout headers_t hdr, inout meta_t meta, inout standard_metadata_t standard_metadata) {
    ...
    @name("do_recirculate") action do_recirculate(@name("new_ipv4_dstAddr") bit<32> new_ipv4_dstAddr_2) {
        hdr.ipv4.dstAddr = new_ipv4_dstAddr_2;
        recirculate_preserving_field_list(8w0);
    }
    @name("do_clone_e2e") action do_clone_e2e(@name("smac") bit<48> smac_2) {

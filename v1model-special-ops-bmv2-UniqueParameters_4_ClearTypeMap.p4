...
control ingress(inout headers_t hdr, inout meta_t meta, inout standard_metadata_t standard_metadata) {
    ...
    @name("ipv4_address_0") bit<32> ipv4_address;
    @name("byte0_0") bit<8> byte0;
    @name("byte1_0") bit<8> byte1;
    @name("byte2_0") bit<8> byte2;
    @name("byte3_0") bit<8> byte3;
    @name("set_l2ptr") action set_l2ptr_0(@name("l2ptr") bit<32> l2ptr_2) {
        meta.fwd.l2ptr = l2ptr_2;
    }
    @name("set_mcast_grp") action set_mcast_grp_0(@name("mcast_grp") bit<16> mcast_grp_1) {
        standard_metadata.mcast_grp = mcast_grp_1;
    }
    @name("do_resubmit") action do_resubmit_0(@name("new_ipv4_dstAddr") bit<32> new_ipv4_dstAddr) {
        hdr.ipv4.dstAddr = new_ipv4_dstAddr;
        resubmit_preserving_field_list(8w0);
    }
    @name("do_clone_i2e") action do_clone_i2e_0(@name("l2ptr") bit<32> l2ptr_3) {
...
control egress(inout headers_t hdr, inout meta_t meta, inout standard_metadata_t standard_metadata) {
    ...
    @name("set_out_bd") action set_out_bd_0(@name("bd") bit<24> bd_2) {
    ...
    @name("do_recirculate") action do_recirculate_0(@name("new_ipv4_dstAddr") bit<32> new_ipv4_dstAddr_2) {
        hdr.ipv4.dstAddr = new_ipv4_dstAddr_2;
        recirculate_preserving_field_list(8w0);
    }
    @name("do_clone_e2e") action do_clone_e2e_0(@name("smac") bit<48> smac_2) {

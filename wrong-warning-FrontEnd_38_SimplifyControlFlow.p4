...
control ingressImpl(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t stdmeta) {
    @name("hu1") hu1_t hu1_0;
    @name("hu1b") hu1_t hu1b_0;
    @name("a1") h1_t[2] a1_0;
    @name("a1b") h1_t[2] a1b_0;
    @name("au1") hu1_t[2] au1_0;
    @name("au1b") hu1_t[2] au1b_0;
    apply {
        hu1_0.h1.setInvalid();
        hu1_0.h2.setInvalid();
        ...
        hu1b_0.h1 = (h1_t){f1 = hdr.ethernet.dstAddr[45:38],f2 = hdr.ethernet.dstAddr[44:37]};
        hu1_0 = hu1b_0;
        au1b_0[0].h1 = (h1_t){f1 = hdr.ethernet.dstAddr[37:30],f2 = hdr.ethernet.dstAddr[36:29]};
        au1b_0[1].h2 = (h2_t){f1 = hdr.ethernet.dstAddr[35:28],f2 = hdr.ethernet.dstAddr[34:27]};
        au1_0 = au1b_0;
        a1_0 = a1b_0;
    }
}

...
control MyIngress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name("forward_and_do_something") action forward_and_do_something_0(@name("port") egressSpec_t port_0) {
    ...
    @name("ipv4_lpm") table ipv4_lpm_0 {
        ...
        actions = {
            forward_and_do_something_0();
            NoAction();
        }
        const entries = {
                        9w1 : forward_and_do_something_0(9w2);
                        9w2 : forward_and_do_something_0(9w1);
        }
        default_action = NoAction();
    }
    @name("debug") table debug_0 {
        key = {
